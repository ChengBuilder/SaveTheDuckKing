...
## 触发场景
- `architecture/docs/asset-readability-audit.md` 仍报告 DuckBundle 存在 `背景`、`随机道具`、`难度飙升`、`newNail/问号`、`newNail/ls1..ls14`、`newNail/lw1..lw14`、`bubble/t0..t12` 这类可读性噪音。
...
## 验证要点
- `subpackages/DuckBundle/config.duck-bundle.json` 不再包含旧中文 canonical 段、`tex/newNail/ls1..ls14`、`tex/newNail/lw1..lw14` 或 `tex/bubble/t0..t12`.
