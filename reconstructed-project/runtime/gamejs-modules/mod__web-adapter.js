...
// Source: source-project/runtime-modules/web-adapter.js
define("runtime/gamejs-modules/web-adapter.js", function (require, module, exports) {
  "use strict";
              ...
              function (e, t, n) {
                ...
                (r.prototype.parseFromString = function (e, t) {
                  var n = this.options,
                    ...
                    c = n.locator,
                    f = n.xmlns || {},
                    d = (t = /\/x?html?$/.test(t)) ? l.entityMap : { lt: "<", gt: ">", amp: "&", quot: '"', apos: "'" };
                  return (
                  ...
                  (o.prototype = {
                    ...
                    startDTD: function (e, t, n) {
                      ...
                      r &&
                        ...
                        ((r = r.createDocumentType(e, t, n)), this.locator && i(this.locator, r), c(this, r));
                    },
                    warning: function (e) {
                ...
                function k(e, t) {
                  ...
                  return (
                    X(
                      ...
                      e,
                      t,
                      (n = a && null == i && null == o.lookupPrefix(a) ? [{ namespace: a, prefix: null }] : n)
                    ),
                    r.join("")
                  );
                }
                  ...
                  (_.prototype = {
                    ...
                    cloneNode: function (e) {
                      return (function e(t, n, r) {
                        ...
                        if (r) for (var p = n.firstChild; p; ) i.appendChild(e(t, p, r)), (p = p.nextSibling);
                        return i;
                  ...
                  (w.prototype.getElementsByTagName = (O.prototype = {
                    ...
                    appendChild: function (e) {
                      return 11 === e.nodeType
                        ...
                        : ((t = this),
                          (n = (e = e).parentNode) && ((r = t.lastChild), n.removeChild(e), (r = t.lastChild)),
                          (r = t.lastChild),
                          (e.parentNode = t),
                          (e.previousSibling = r),
                          (e.nextSibling = null),
                    ...
                    r.startDocument(),
                      ...
                      (function (e, t, n, r, o) {
                        ...
                        function a(t) {
                          var n;
                          y < t &&
                            ((n = e.substring(y, t).replace(/&#?\w+;/g, i)), m && l(y), r.characters(n, 0, t - y), (y = t));
                        }
                        function l(t, n) {
                        ...
                        for (
                          ...
                          try {
                            ...
                            if (_ < 0)
                              return (
                                e.substr(y).match(/^\s*$/) ||
                                ((v = (b = r.doc).createTextNode(e.substr(y))), b.appendChild(v), (r.currentElement = v))
                              );
                            switch ((y < _ && a(_), e.charAt(_ + 1))) {
                              case "/":
                                ...
                                if (S || (w.tagName && w.tagName.toLowerCase() == g.toLowerCase())) {
                                  if ((r.endElement(w.uri, w.localName, g), N)) for (var R in N) r.endPrefixMapping(R);
                                  S ||
                                    o.fatalError(
                                      "end tag name: " + g + " is not match the current start tagName:" + w.tagName
                                    );
                                } else h.push(w);
                                T++;
                                break;
                                        ...
                                        switch (l) {
                                          ...
                                          case '"':
                                            if (3 === c || 1 === c) {
                                              if (
                                                (1 === c &&
                                                  (i.warning('attribute value must after "="'), (a = e.slice(t, u))),
                                                (t = u + 1),
                                                !(0 < (u = e.indexOf(l, t))))
                                              )
                                          ...
                                          case "":
                                            return (
                                              i.error("unexpected end of input"), 0 == c && n.setTagName(e.slice(t, u)), u
                                            );
                                          case ">":
                                            switch (c) {
                                              case 0:
                                ...
                                if (
                                  (!A.closed &&
                                    (function (e, t, n, r) {
                                      ...
                                      return (
                                        null == o &&
                                          ((o = e.lastIndexOf("</" + n + ">")) < t && (o = e.lastIndexOf("</" + n)),
                                          (r[n] = o)),
                                        o < t
                                      );
                                    })(e, T, A.tagName, E) &&
              ...
              function (t, n, r) {
                ...
                function c(e) {
                  ...
                  return function () {
                    var n,
                      r = l(e);
                    (n = t ? ((n = l(this).constructor), Reflect.construct(r, arguments, n)) : r.apply(this, arguments)),
                      (r = this);
                ...
                t = (function (e) {
                  ...
                  function r(e) {
                    ...
                    return (
                      (f[t._$sn] = o),
                      (t._canplayEvents = ["load", "loadend", "canplay", "canplaythrough", "loadedmetadata"]),
                    ...
                    (e = [
                      {
                        ...
                        value: function (e, t) {
                          ...
                          a(l(r.prototype), "addEventListener", this).call(this, e, t, n),
                            ...
                            this._loaded && -1 !== this._canplayEvents.indexOf(e) && this.dispatchEvent({ type: e });
                        }
                      },
                      ...
                      },
                      {
                        ...
                        value: function () {
                          ...
                          return "string" == typeof e && (-1 < e.indexOf("audio/mpeg") || e.indexOf("audio/mp4"))
                            ? "probably"
                            : "";
                        }
                      },
              ...
              function (t, n, r) {
                ...
                function a(e) {
                  ...
                  return function () {
                    var n,
                      r = c(e);
                    (n = t ? ((n = c(this).constructor), Reflect.construct(r, arguments, n)) : r.apply(this, arguments)),
                      (r = this);
                    if (n && ("object" === o(n) || "function" == typeof n)) return n;
                    if (void 0 !== n) throw new TypeError("Derived constructors may only return object or undefined");
                    return u(r);
              ...
              function (t, n, r) {
                ...
                function a(e) {
                  ...
                  return function () {
                    var n,
                      r = u(e);
                    (n = t ? ((n = u(this).constructor), Reflect.construct(r, arguments, n)) : r.apply(this, arguments)),
                      (r = this);
                    if (n && ("object" === o(n) || "function" == typeof n)) return n;
                    if (void 0 !== n) throw new TypeError("Derived constructors may only return object or undefined");
                    if (void 0 !== r) return r;
              ...
              function (t, n, r) {
                ...
                function s(e) {
                  ...
                  return function () {
                    var n,
                      r = d(e);
                    (n = t ? ((n = d(this).constructor), Reflect.construct(r, arguments, n)) : r.apply(this, arguments)),
                      (r = this);
                  ...
                  function r() {
                    ...
                    if (t instanceof o)
                      return (
                        ...
                        p(f(t), "childern", []),
                        p(f(t), "style", { width: "".concat(a.innerWidth, "px"), height: "".concat(a.innerHeight, "px") }),
                      ...
                      if (this instanceof r)
                        return (
                          ...
                          (o = s((o = "childNodes"))) in t
                            ? Object.defineProperty(t, o, { value: i, enumerable: !0, configurable: !0, writable: !0 })
                            : (t[o] = i),
                          e
                        );
                      throw new TypeError("Cannot call a class as a function");
                  ...
                  l = (function () {
                    function e(t) {
                      ...
                      if (
                        ...
                        throw new TypeError("Failed to construct 'WebSocket': The URL '".concat(t, "' is invalid"));
                      return (
                        (this.url = t),
                        (this.readyState = e.CONNECTING),
                        (o = wx.connectSocket({ url: t, protocols: Array.isArray(r) ? r : [r], tcpNoDelay: !0 })),
                        c.set(this, o),
                    ...
                    return (
                      ...
                      (n = [
                        ...
                        },
                        {
                          key: "send",
                          value: function (e) {
                            if (!("string" == typeof e || e instanceof ArrayBuffer || ArrayBuffer.isView(e)))
                              throw new TypeError("Failed to send message: The data ".concat(e, " is invalid"));
                ...
                if (!GameGlobal.__isAdapterInjected)
                  if (
                    ...
                    for (var s in i.document) {
                      ...
                      (f && !0 !== f.configurable) || Object.defineProperty(u.document, s, { value: i.document[s] });
                    }
              ...
              function (e, t, n) {
                ...
                var r = wx.getSystemInfoSync(),
                  ...
                  u =
                    ...
                    (r = "Mozilla/5.0 ("
                      .concat(o, ") AppleWebKit/603.1.30 (KHTML, like Gecko) Mobile/14E8301 MicroMessenger/")
                  ...
                  i = {
                    ...
                    writeFileSync: function (e, t, n) {
                      try {
                        ...
                        return (
                          console.warn("Write file failed: path: ".concat(e, " message: ").concat(t.message)),
                          new Error(t.message)
                        );
                      }
                    },
                      ...
                      i.readFile(e, "utf8", function (n, r) {
                        ...
                        if (!n)
                          try {
                            ...
                            console.warn("Read json failed: path: ".concat(e, " message: ").concat(r.message)),
                    ...
                    readJsonSync: function (e) {
                      try {
                        ...
                        return (
                          console.warn("Read json failed: path: ".concat(e, " message: ").concat(t.message)),
                          new Error(t.message)
                        );
                      }
                    },
                    makeDirSync: function (e, t) {
                      try {
                        ...
                        return (
                          console.warn("Make directory failed: path: ".concat(e, " message: ").concat(t.message)),
                          new Error(t.message)
                        );
                      }
                    },
                    rmdirSync: function (e, t) {
                      try {
                        ...
                        return (
                          console.warn("rm directory failed: path: ".concat(e, " message: ").concat(t.message)),
                          new Error(t.message)
                        );
                      }
                    },
