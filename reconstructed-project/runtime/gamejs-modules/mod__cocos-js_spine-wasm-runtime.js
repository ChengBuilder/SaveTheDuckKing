...
// Source: source-project/runtime-modules/cocos-js/spine-wasm-runtime.js
define("runtime/gamejs-modules/cocos-js/spine-wasm-runtime.js", function (require, module, exports) {
  "use strict";

      // Auto-generated by architecture/tools/split-gamejs-into-modules.js
        require("../@babel/runtime/helpers/Arrayincludes");
        var n = require("../@babel/runtime/helpers/typeof");
        System.register(["./_virtual_cc.js"], function (t) {
          var e;
          return {
            setters: [
              function (n) {
              ...
              t(
                ...
                function (t) {
                  ...
                  function Y(n, t) {
                    ...
                    var e = t.name;
                    if ((n || B('type "' + e + '" must have a positive integer typeid pointer'), x.hasOwnProperty(n))) {
                      if ({}.qa) return;
                  ...
                  function dn(n, t, e) {
                    for (; t !== e; )
                      t.W || B("Expected null or instance of " + e.name + ", got an instance of " + t.name),
                        (n = t.W(n)),
                        (t = t.J);
                    return n;
                  }
                  ...
                  function yn(n, t) {
                    ...
                    if (
                      ...
                      switch ((void 0 === t.F.L && B("Passing raw pointer to smart pointer is illegal"), this.pa)) {
                        case 0:
                          t.F.M === this
                            ? (e = t.F.L)
                            : B(
                  ...
                  function mn(n, t) {
                    return null === t
                      ...
                      : (t.F || B('Cannot pass "' + Rn(t) + '" as a ' + this.name),
                        t.F.H || B("Cannot pass deleted object as a pointer of type " + this.name),
                        t.F.I.Y && B("Cannot convert argument of type " + t.F.I.name + " to parameter type " + this.name),
                        dn(t.F.H, t.F.I.G, this.G));
                  }
                  function gn(n) {
                  ...
                  function bn(n, t, e, r) {
                    (this.name = n),
                      ...
                      void 0 !== t.J ? (this.toWireType = yn) : ((this.toWireType = r ? vn : mn), (this.O = null));
                  }
                  function wn(n, t) {
                  ...
                  function Fn(n, t) {
                    var e = (n = M(n)).includes("j")
                      ...
                      : T.get(t);
                    return "function" != typeof e && B("unknown function pointer with signature " + n + ": " + t), e;
                  }
                  var Tn = void 0;
                  function Cn(n) {
                    var t = M((n = Zn(n)));
                  ...
                  function Wn(n, t, e, r, i) {
                    var o = t.length;
                    2 > o && B("argTypes array size mismatch! Must at least get return value and 'this' types!");
                    ...
                    return function () {
                      if (
                        (arguments.length !== c &&
                          B("function " + n + " called with " + arguments.length + " arguments, expected " + c + " args!"),
                        (h.length = 0),
                        (l.length = a ? 2 : 1),
                        (l[0] = i),
                        a)
                  ...
                  function On(n, t, e) {
                    return (
                      ...
                      n instanceof t.G.constructor || B(e + ' incompatible with "this" of type ' + n.constructor.name),
                  ...
                  (_ = Nn),
                    ...
                    (fn.prototype.clone = function () {
                      ...
                      return (
                        ((n = n(
                          e.call(t, r, { F: { value: { count: i.count, U: i.U, V: i.V, H: i.H, I: i.I, L: i.L, M: i.M } } })
                        )).F.count.value += 1),
                        (n.F.U = !1),
                        n
                      );
                    ...
                    (bn.prototype.fromWireType = function (n) {
                      function t() {
                        return this.Z ? sn(this.G.P, { I: this.ka, H: e, M: this, L: n }) : sn(this.G.P, { I: this, H: n });
                      }
                      var e = this.ja(n);
                      if (!e) return this.ca(n), null;
                      var r = (function (n, t) {
                        for (void 0 === t && B("ptr should not be undefined"); n.J; ) (t = n.W(t)), (n = n.J);
                        return un[t];
                      })(this.G, e);
                      if (void 0 !== r)
                      ...
                      c: function (n, t, e, r, i, o, a, u, s, c, f, l, h) {
                        ...
                        hn(p, function () {
                          ...
                          X([n, t, e], r ? [r] : [], function (t) {
                            ...
                            t = V(p, function () {
                              if (Object.getPrototypeOf(this) !== a) throw new z("Use 'new' to construct " + f);
                      ...
                      g: function (n, t, r, i, o, a, u) {
                        ...
                        (t = M(t)),
                          ...
                          X([], [n], function (n) {
                            ...
                            return (
                              void 0 === c[t] ? ((i.T = r - 1), (c[t] = i)) : (ln(c, t, o), (c[t].K[r - 1] = i)),
                              X([], s, function (i) {
                                if (
                  ...
                  function Xn() {
                    ...
                    if (!(0 < O)) {
                      if (i.preRun) for ("function" == typeof i.preRun && (i.preRun = [i.preRun]); i.preRun.length; ) W();
                      U(C),
                        0 < O ||
                          (i.setStatus
                            ? (i.setStatus("Running..."),
