...
// Source: source-project/runtime-modules/engine-adapter.js
define("runtime/gamejs-modules/engine-adapter.js", function (require, module, exports) {
  "use strict";
              ...
              function (e, t, n) {
                ...
                function y(t, n, i) {
                  h.test(t)
                    ...
                    : (v.platform !== v.Platform.TAOBAO_CREATIVE_APP && e("../../../".concat(t)), i && i(null));
                }
                function g(e, t, n) {
                  ...
                  c.inLocal
                    ...
                    : a(e, null, n.header, o, function (o, a) {
                        o
                          ? r(o, null)
                          : t(a, n, function (t, o) {
                              t || (i.tempFiles.add(e, a), i.cacheFile(e, a, n.cacheEnabled, n.__cacheBundleRoot__, !0)),
                                r(t, o);
                            });
                      });
                }
                      ...
                      _[p]
                        ...
                        : (h.test(t) || t.startsWith(u())
                            ...
                            ? ((d = "".concat(f.remoteServerAddress, "remote/").concat(p)),
                              (s = "src/bundle-scripts/".concat(p, "/index.").concat(m, "js")),
                              i.makeBundleFolder(p))
                            : ((d = "assets/".concat(p)), (s = "assets/".concat(p, "/index.").concat(m, "js"))),
                          v.platform === v.Platform.TAOBAO_MINI_GAME
                            ? e(s)
            ...
            2: [
              function (e, t, n) {
                function i() {
                  (this._delegate = null),
                    (this._editing = !1),
                    (this._eventListeners = { onKeyboardInput: null, onKeyboardConfirm: null, onKeyboardComplete: null });
                }
                var o, a, r, c, s;
                cc &&
                  cc.internal &&
                  ...
                  Object.assign(i.prototype, {
                    ...
                    _registerKeyboardEvent: function () {
                      ...
                      (n.onKeyboardInput = function (e) {
                        ...
                        (n.onKeyboardComplete = function (n) {
                          (e._editing = !1),
                            (s = null),
                            cc.sys.platform !== cc.sys.Platform.WECHAT_MINI_PROGRAM && e._unregisterKeyboardEvent(),
                            n && n.value && n.value !== t.string && t._editBoxTextChanged(n.value),
                            n && n.value ? t._editBoxEditingDidEnded(n.value) : t._editBoxEditingDidEnded();
                        }),
                    ...
                    _unregisterKeyboardEvent: function () {
                      ...
                      e.onKeyboardInput && (__globalAdapter.offKeyboardInput(e.onKeyboardInput), (e.onKeyboardInput = null)),
                        e.onKeyboardConfirm &&
                          (__globalAdapter.offKeyboardConfirm(e.onKeyboardConfirm), (e.onKeyboardConfirm = null)),
                        e.onKeyboardComplete &&
                          (__globalAdapter.offKeyboardComplete(e.onKeyboardComplete), (e.onKeyboardComplete = null));
                    },
              ...
              function (e, t, n) {
                ...
                cc.assetManager.cacheManager = t.exports = {
                  ...
                  init: function () {
                    ...
                    t instanceof Error || !t.version
                      ? (t instanceof Error || d(this.cacheDir, !0),
                        ...
                        r(this.cacheDir, !0),
                        c(e, JSON.stringify({ files: this.cachedFiles._map, version: this.version }), "utf8"))
                  ...
                  _cache: function () {
                    ...
                    function d(e) {
                      ...
                      delete c.cacheQueue[u],
                        cc.js.isEmptyObject(c.cacheQueue) || p || ((p = !0), setTimeout(c._cache.bind(c), c.cacheInterval));
                    }
                    u &&
                      ...
                      (a = Date.now().toString()),
                      (r = ""),
                      (r = (o ? "".concat(this.cacheDir, "/").concat(o, "/") : "".concat(this.cacheDir, "/"))
                        .concat(a)
                        .concat(v++)
                  ...
                  removeCache: function (e) {
                    var t;
                    this.cachedFiles.has(e) &&
                      ((t = this.cachedFiles.remove(e).url), clearTimeout(m), this._write(), this._removePathOrFile(e, t));
                  },
                  ...
                  unzipAndCacheBundle: function (e, t, n, i) {
                    ...
                    r(a, !0),
                      h(t, a, function (t) {
                        t
                          ? (d(a, !0), f(t.message) && ((c.outOfStorage = !0), c.autoClear) && c.clearLRU(), i && i(t))
                          : (c.cachedFiles.add(e, { bundle: n, url: a, lastTime: o }), c.writeCacheFile(), i && i(null, a));
                      });
                  },
              ...
              function (t, n, i) {
                ...
                function c(e) {
                  ...
                  return function () {
                    var n,
                      i = s(e);
                    (n = t ? ((n = s(this).constructor), Reflect.construct(i, arguments, n)) : i.apply(this, arguments)),
                      (i = this);
                        ...
                        },
                        {
                          ...
                          value: function () {
                            ...
                            e &&
                              ...
                              e.onEnded(function () {
                                t._video === e &&
                                  ((t._playing = !1), (t._currentTime = t._duration), t.dispatchEvent(l.COMPLETED));
                              }),
                              e.onPause(function () {
                        ...
                        },
                        {
                          ...
                          value: function (e) {
                            ...
                            t &&
                              ...
                              (e ? t.requestFullScreen() : t.exitFullScreen(), (this._fullScreenEnabled = e));
                          }
                        },
                        {
