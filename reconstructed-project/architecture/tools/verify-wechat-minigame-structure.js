...
const SOURCE_ASSET_DIRECTORIES = Object.freeze([
  'assets/audio',
  'assets/data',
  'assets/fonts',
  'assets/particles',
...
const ALLOWED_ASSETS_ROOT_DIRECTORIES = Object.freeze(
  REQUIRED_CANONICAL_ROOT_BUNDLES.concat(REQUIRED_ROOT_BUNDLE_SHELLS, ['assets/scene'], SOURCE_ASSET_DIRECTORIES)
);
...
/**
 * 校验 assets 根目录是否仍符合“canonical 根 bundle + Creator 源目录 + 最小历史命名薄壳”的约束。
 * @param {{projectRoot: string, projectPathFromWorkspace: string}} layout 项目布局
 * @param {string[]} errors 错误收集器
 */
