...
System.register("chunks:///_virtual/Game2Controller.ts",["./rollupPluginModLoBabelHelpers.js","cc","./FruitManager.ts","./Enum.ts","./EventManager.ts","./GameCtrl.ts","./Util.ts","./Fruit.ts","./AudioManager.ts","./GameModel2.ts","./ResManager.ts","./TooYueManager.ts","./ConfigTable.ts","./RevivePanelView.ts","./AdManager.ts","./PropPanelView.ts","./PoolManager.ts","./GameData2.ts"],(function(e){
  var t,n,o,r,a,s,l,c,u,d,h,p,f,g,m,v,y,_,b,S,C,w,N,k,T,B,A,P,M,I,F,R,L,x,D,G,E,O,H,V,U,z,W,j,J,Y;
  return{
    setters:[function(e){
    ...
    ,function(e){
      s=e.cclegacy,l=e._decorator,c=e.Node,u=e.Material,d=e.find,h=e.Label,p=e.Button,f=e.BoxCollider2D,g=e.Sprite,m=e.sp,v=e.tween,y=e.v3,_=e.instantiate,b=e.UIOpacity,S=e.PhysicsSystem2D,C=e.director,w=e.Color,N=e.Tween,k=e.Vec3,T=e.Component,B=e.view,A=e.UITransform}
    ,function(e){
      P=e.FruitManager}
    ,function(e){
