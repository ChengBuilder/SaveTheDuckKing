...
System.register("chunks:///_virtual/Game.ts",["./rollupPluginModLoBabelHelpers.js","cc","./GameCtl.ts","./JumpTween.ts","./FruitNodePool.ts","./GyroscopeManager.ts","./ResManager.ts","./AudioManager.ts","./GameModel2.ts","./ConfigTable.ts","./GameCtrl.ts","./PropPanelView.ts","./EventManager.ts","./Enum.ts","./RevivePanelView.ts","./Util.ts","./TooYueManager.ts"],(function(e){
  var t,n,i,o,r,a,s,l,c,u,d,h,p,f,g,m,v,y,_,b,S,C,w,N,k,T,B,A,P,M,I,F,R,L,x,D,G,E,O,H,V,U,z,W,j,J,Y,q,K,X,Q,Z,$,ee;
  return{
    setters:[function(e){
      t=e.applyDecoratedDescriptor,n=e.initializerDefineProperty,i=e.inheritsLoose,o=e.assertThisInitialized,r=e.createForOfIteratorHelperLoose,a=e.createClass}
    ,function(e){
      s=e.cclegacy,l=e._decorator,c=e.AudioClip,u=e.Node,d=e.Button,h=e.Material,p=e.PolygonCollider2D,f=e.Label,g=e.Graphics,m=e.EditBox,v=e.RigidBody2D,y=e.sp,_=e.Vec3,b=e.find,S=e.sys,C=e.macro,w=e.instantiate,N=e.UIOpacity,k=e.tween,T=e.v3,B=e.easing,A=e.Sprite,P=e.Tween,M=e.Color,I=e.UITransform,F=e.DistanceJoint2D,R=e.ERigidBody2DType,L=e.resources,x=e.SpriteFrame,D=e.Quat,G=e.Vec2,E=e.Component}
    ,function(e){
      O=e.GameCtl}
    ,function(e){
      H=e.jumpTo}
