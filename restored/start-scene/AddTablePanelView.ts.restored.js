...
System.register("chunks:///_virtual/AddTablePanelView.ts",["./rollupPluginModLoBabelHelpers.js","cc","./AudioManager.ts","./GameModel2.ts","./ResManager.ts","./GameCtrl.ts","./Enum.ts","./ReceivePanelView.ts","./ConfigTable.ts","./TooYueManager.ts"],(function(e){
  ...
  return{
    ...
    ,function(e){
      s=e.cclegacy,l=e._decorator,c=e.Node,u=e.Button,d=e.SpriteFrame,h=e.tween,p=e.UIOpacity,f=e.v3,g=e.assetManager,m=e.Prefab,v=e.Sprite,y=e.instantiate,_=e.find,b=e.Component,S=e.director}
    ,function(e){
      C=e.AudioManager}
    ,function(e){
      w=e.GameModel}
