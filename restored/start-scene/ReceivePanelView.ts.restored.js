...
System.register("chunks:///_virtual/ReceivePanelView.ts",["./rollupPluginModLoBabelHelpers.js","cc","./AudioManager.ts","./GameModel2.ts","./GameCtrl.ts","./Enum.ts","./Util.ts"],(function(e){
  ...
  return{
    ...
    ,function(e){
      r=e.cclegacy,a=e._decorator,s=e.Node,l=e.Button,c=e.SpriteFrame,u=e.v3,d=e.tween,h=e.UIOpacity,p=e.Sprite,f=e.UITransform,g=e.Label,m=e.Color,v=e.HorizontalTextAlignment,y=e.Component}
    ,function(e){
      _=e.AudioManager}
    ,function(e){
      b=e.GameModel}
