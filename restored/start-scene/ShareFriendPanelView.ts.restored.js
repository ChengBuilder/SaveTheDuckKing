...
System.register("chunks:///_virtual/ShareFriendPanelView.ts",["./rollupPluginModLoBabelHelpers.js","cc","./AudioManager.ts","./GameModel2.ts","./ResManager.ts","./GameCtrl.ts","./ConfigTable.ts","./TooYueManager.ts","./ServiceManager.ts","./ReceivePanelView.ts"],(function(e){
  ...
  return{
    ...
    ,function(e){
      r=e.cclegacy,a=e._decorator,s=e.Node,l=e.Button,c=e.v3,u=e.tween,d=e.UIOpacity,h=e.assetManager,p=e.Prefab,f=e.Sprite,g=e.Label,m=e.ProgressBar,v=e.instantiate,y=e.find,_=e.Component}
    ,function(e){
      b=e.AudioManager}
    ,function(e){
      S=e.GameModel}
