...
System.register("chunks:///_virtual/LoadScene.ts",["./rollupPluginModLoBabelHelpers.js","cc","./GameModel2.ts","./ResManager.ts","./Enum.ts","./AudioManager.ts","./ServiceManager.ts","./AdManager.ts","./TooYueManager.ts","./AdManager_ZJ.ts","./AdManager_WX.ts"],(function(e){
  ...
  return{
    ...
    ,function(e){
      s=e.cclegacy,l=e._decorator,c=e.ProgressBar,u=e.Enum,d=e.Node,h=e.SpriteFrame,p=e.assetManager,f=e.error,g=e.director,m=e.tween,v=e.log,y=e.v3,_=e.Component,b=e.sys,S=e.View,C=e.ResolutionPolicy,w=e.UIOpacity}
    ,function(e){
      N=e.GameModel}
    ,function(e){
      k=e.ResManager}
