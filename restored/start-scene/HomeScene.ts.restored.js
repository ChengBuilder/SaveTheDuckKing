...
System.register("chunks:///_virtual/HomeScene.ts",["./rollupPluginModLoBabelHelpers.js","cc","./GameModel2.ts","./GameCtrl.ts","./AudioManager.ts","./ResManager.ts","./Enum.ts","./ConfigTable.ts","./AddTablePanelView.ts","./AdManager.ts","./ReceivePanelView.ts","./Util.ts","./AddPowerPanelView.ts","./EventManager.ts","./AdManager_ZJ.ts","./TooYueManager.ts"],(function(e){
  var t,n,o,r,a,s,l,c,u,d,h,p,f,g,m,v,y,_,b,S,C,w,N,k,T,B,A,P,M,I,F,R,L,x,D,G,E;
  return{
    setters:[function(e){
      t=e.inheritsLoose,n=e.asyncToGenerator}
    ,function(e){
      o=e.cclegacy,r=e._decorator,a=e.instantiate,s=e.UIOpacity,l=e.tween,c=e.v3,u=e.sp,d=e.UITransform,h=e.Sprite,p=e.Tween,f=e.view,g=e.Vec3,m=e.find,v=e.Button,y=e.EditBox,_=e.Label,b=e.Color,S=e.easing,C=e.director,w=e.Component}
    ,function(e){
      N=e.GameModel}
    ,function(e){
      k=e.GameCtrl}
