...
System.register("chunks:///_virtual/OverPanelView.ts",["./rollupPluginModLoBabelHelpers.js","cc","./GameModel2.ts","./AudioManager.ts","./Enum.ts","./EventManager.ts","./GameCtrl.ts","./Util.ts","./ConfigTable.ts","./ResManager.ts","./AddPowerPanelView.ts","./DuckController.ts","./TooYueManager.ts","./AutoManager.ts","./Game2Controller.ts","./Game.ts"],(function(e){
  var t,n,i,o,r,a,s,l,c,u,d,h,p,f,g,m,v,y,_,b,S,C,w,N,k,T,B,A,P,M,I,F,R,L,x,D,G,E;
  return{
    setters:[function(e){
      t=e.applyDecoratedDescriptor,n=e.inheritsLoose,i=e.initializerDefineProperty,o=e.assertThisInitialized}
    ,function(e){
      r=e.cclegacy,a=e._decorator,s=e.Node,l=e.Button,c=e.Label,u=e.SpriteFrame,d=e.director,h=e.Sprite,p=e.UITransform,f=e.sp,g=e.UIOpacity,m=e.tween,v=e.v3,y=e.instantiate,_=e.find,b=e.ProgressBar,S=e.assetManager,C=e.Prefab,w=e.Component}
    ,function(e){
      N=e.GameModel}
    ,function(e){
      k=e.AudioManager}
