...
System.register("chunks:///_virtual/AwemePanelView.ts",["./rollupPluginModLoBabelHelpers.js","cc","./AudioManager.ts","./GameModel2.ts","./ResManager.ts","./GameCtrl.ts","./Enum.ts","./ReceivePanelView.ts","./ConfigTable.ts","./TooYueManager.ts","./AdManager_ZJ.ts"],(function(e){
  ...
  return{
    ...
    ,function(e){
      s=e.cclegacy,l=e._decorator,c=e.Node,u=e.Button,d=e.SpriteFrame,h=e.tween,p=e.UIOpacity,f=e.v3,g=e.assetManager,m=e.Prefab,v=e.Sprite,y=e.Component,_=e.find,b=e.instantiate}
    ,function(e){
      S=e.AudioManager}
    ,function(e){
      C=e.GameModel}
