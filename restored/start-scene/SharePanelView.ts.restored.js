...
System.register("chunks:///_virtual/SharePanelView.ts",["./rollupPluginModLoBabelHelpers.js","cc","./AudioManager.ts","./GameModel2.ts","./ResManager.ts","./GameCtrl.ts","./ReceivePanelView.ts","./ConfigTable.ts","./TooYueManager.ts"],(function(e){
  ...
  return{
    ...
    ,function(e){
      r=e.cclegacy,a=e._decorator,s=e.Node,l=e.Button,c=e.SpriteFrame,u=e.tween,d=e.UIOpacity,h=e.v3,p=e.assetManager,f=e.Prefab,g=e.Label,m=e.instantiate,v=e.find,y=e.director,_=e.Component}
    ,function(e){
      b=e.AudioManager}
    ,function(e){
      S=e.GameModel}
