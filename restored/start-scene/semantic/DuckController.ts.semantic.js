/**
 * Semantic view: chunks:///_virtual/DuckController.ts
...
System.register("chunks:///_virtual/DuckController.ts",["./rollupPluginModLoBabelHelpers.js","cc","./GameModel2.ts","./ResManager.ts","./Util.ts","./GameCtrl.ts","./AudioManager.ts","./Enum.ts","./EventManager.ts","./AdManager.ts","./ConfigTable.ts","./PropPanelView.ts","./RevivePanelView.ts","./Wood.ts","./Nail.ts","./GameData.ts","./TooYueManager.ts","./AdManager_ZJ.ts","./ReceivePanelView.ts","./AutoManager.ts"],(function(e){
  var t /* applyDecoratedDescriptor */, n /* inheritsLoose */, o /* initializerDefineProperty */, r /* assertThisInitialized */, a /* asyncToGenerator */, s /* cclegacy */, l /* _decorator */, c /* SpriteFrame */, u /* Material */, d, h /* find */, p /* Label */, f /* tween */, g /* Sprite */, m /* Color */, v /* PhysicsSystem2D */, y /* Button */, _ /* BoxCollider2D */, b /* instantiate */, S /* UIOpacity */, C /* UITransform */, w, N /* ProgressBar */, k /* view */, T /* Tween */, B, A /* Intersection2D */, P /* HingeJoint2D */, M /* director */, I /* Node */, F /* Camera */, R /* Vec3 */, L /* Component */, x /* RigidBody2D */, D /* easing */, G /* PolygonCollider2D */, E /* GameModel */, O /* ResManager */, H /* Util */, V /* GameCtrl */, U /* AudioManager */, z /* EVENT_KEYS */, W /* releaseType */, j /* COLLIDER_TAG */, J /* PHY_GROUP */, Y /* PROP_TYPE */, q /* default */, K /* AdManager */, X /* UIConfigTable */, Q /* PropPanelView */, Z /* RevivePanelView */, $, ee /* Nail */, te /* GameData */, ne /* TooYueManager */, ie /* AdManager_ZJ */, oe /* TT_EVENT_KEYS */, re /* ReceivePanelView */, ae /* AutoManager */;
  return{
    setters:[function(e){
    ...
    ,function(e){
      s=e.cclegacy /* cclegacy */,l=e._decorator /* _decorator */,c=e.SpriteFrame /* SpriteFrame */,u=e.Material /* Material */,d=e.v3,h=e.find /* find */,p=e.Label /* Label */,f=e.tween /* tween */,g=e.Sprite /* Sprite */,m=e.Color /* Color */,v=e.PhysicsSystem2D /* PhysicsSystem2D */,y=e.Button /* Button */,_=e.BoxCollider2D /* BoxCollider2D */,b=e.instantiate /* instantiate */,S=e.UIOpacity /* UIOpacity */,C=e.UITransform /* UITransform */,w=e.sp,N=e.ProgressBar /* ProgressBar */,k=e.view /* view */,T=e.Tween /* Tween */,B=e.v2,A=e.Intersection2D /* Intersection2D */,P=e.HingeJoint2D /* HingeJoint2D */,M=e.director /* director */,I=e.Node /* Node */,F=e.Camera /* Camera */,R=e.Vec3 /* Vec3 */,L=e.Component /* Component */,x=e.RigidBody2D /* RigidBody2D */,D=e.easing /* easing */,G=e.PolygonCollider2D /* PolygonCollider2D */}
    ,function(e){
      E=e.GameModel /* GameModel */}
    ,function(e){
      O=e.ResManager /* ResManager */}
    ,function(e){
      H=e.Util /* Util */}
    ,function(e){
      V=e.GameCtrl /* GameCtrl */}
    ,function(e){
      U=e.AudioManager /* AudioManager */}
    ,function(e){
      z=e.EVENT_KEYS /* EVENT_KEYS */,W=e.releaseType /* releaseType */,j=e.COLLIDER_TAG /* COLLIDER_TAG */,J=e.PHY_GROUP /* PHY_GROUP */,Y=e.PROP_TYPE /* PROP_TYPE */}
    ,function(e){
      q=e.default /* default */}
    ,function(e){
      K=e.AdManager /* AdManager */}
    ,function(e){
      X=e.UIConfigTable /* UIConfigTable */}
    ,function(e){
    ...
    ,function(e){
      ee=e.Nail /* Nail */}
    ,function(e){
      te=e.GameData /* GameData */}
    ,function(e){
      ne=e.TooYueManager /* TooYueManager */}
    ,function(e){
      ie=e.AdManager_ZJ /* AdManager_ZJ */,oe=e.TT_EVENT_KEYS /* TT_EVENT_KEYS */}
    ,function(e){
      re=e.ReceivePanelView /* ReceivePanelView */}
    ,function(e){
      ae=e.AutoManager /* AutoManager */}
    ],execute:function(){
