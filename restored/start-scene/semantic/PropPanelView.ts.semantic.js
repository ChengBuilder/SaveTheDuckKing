/**
 * Semantic view: chunks:///_virtual/PropPanelView.ts
...
System.register("chunks:///_virtual/PropPanelView.ts",["./rollupPluginModLoBabelHelpers.js","cc","./Enum.ts","./GameModel2.ts","./Util.ts","./EventManager.ts","./AudioManager.ts","./GameCtrl.ts","./ConfigTable.ts","./DuckController.ts","./TooYueManager.ts","./AutoManager.ts","./Game2Controller.ts","./ResManager.ts"],(function(e){
  var t /* applyDecoratedDescriptor */, n /* inheritsLoose */, i /* initializerDefineProperty */, o /* assertThisInitialized */, r /* cclegacy */, a /* _decorator */, s /* Node */, l /* Button */, c /* Label */, u /* SpriteFrame */, d /* UIOpacity */, h /* Sprite */, p /* tween */, f, g /* assetManager */, m /* Prefab */, v /* director */, y /* find */, _ /* Component */, b /* PROP_TYPE */, S /* releaseType */, C /* EVENT_KEYS */, w /* GameModel */, N /* Util */, k /* default */, T /* AudioManager */, B /* GameCtrl */, A /* UIConfigTable */, P /* DuckController */, M /* TooYueManager */, I /* AutoManager */, F /* Game2Controller */, R /* ResManager */;
  return{
    setters:[function(e){
    ...
    ,function(e){
      r=e.cclegacy /* cclegacy */,a=e._decorator /* _decorator */,s=e.Node /* Node */,l=e.Button /* Button */,c=e.Label /* Label */,u=e.SpriteFrame /* SpriteFrame */,d=e.UIOpacity /* UIOpacity */,h=e.Sprite /* Sprite */,p=e.tween /* tween */,f=e.v3,g=e.assetManager /* assetManager */,m=e.Prefab /* Prefab */,v=e.director /* director */,y=e.find /* find */,_=e.Component /* Component */}
    ,function(e){
      b=e.PROP_TYPE /* PROP_TYPE */,S=e.releaseType /* releaseType */,C=e.EVENT_KEYS /* EVENT_KEYS */}
    ,function(e){
    ...
    ,function(e){
      F=e.Game2Controller /* Game2Controller */}
    ,function(e){
      R=e.ResManager /* ResManager */}
    ],execute:function(){
