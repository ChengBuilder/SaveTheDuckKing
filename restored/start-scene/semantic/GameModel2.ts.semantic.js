/**
 * Semantic view: chunks:///_virtual/GameModel2.ts
...
System.register("chunks:///_virtual/GameModel2.ts",["./rollupPluginModLoBabelHelpers.js","cc","./Singleton.ts"],(function(e){
  var t /* inheritsLoose */, n /* createClass */, i /* cclegacy */, o /* _decorator */, r /* sys */, a /* view */, s /* default */;
  return{
    setters:[function(e){
      t=e.inheritsLoose /* inheritsLoose */,n=e.createClass /* createClass */}
    ,function(e){
      i=e.cclegacy /* cclegacy */,o=e._decorator /* _decorator */,r=e.sys /* sys */,a=e.view /* view */}
    ,function(e){
      s=e.default /* default */}
    ],execute:function(){
      var l,c;
