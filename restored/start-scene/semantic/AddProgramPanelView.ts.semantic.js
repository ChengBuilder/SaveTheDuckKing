/**
 * Semantic view: chunks:///_virtual/AddProgramPanelView.ts
...
var t /* applyDecoratedDescriptor */, n /* inheritsLoose */, i /* initializerDefineProperty */, o /* assertThisInitialized */, r /* cclegacy */, a /* _decorator */, s /* Node */, l /* Button */, c /* SpriteFrame */, u /* tween */, d /* UIOpacity */, h, p /* assetManager */, f /* Prefab */, g /* Sprite */, m /* instantiate */, v /* find */, y /* Component */, _ /* AudioManager */, b /* GameModel */, S /* ResManager */, C /* UIConfigTable */, w /* GameCtrl */, N /* ReceivePanelView */;
return{
setters:[function(e){
...
,function(e){
r=e.cclegacy /* cclegacy */,a=e._decorator /* _decorator */,s=e.Node /* Node */,l=e.Button /* Button */,c=e.SpriteFrame /* SpriteFrame */,u=e.tween /* tween */,d=e.UIOpacity /* UIOpacity */,h=e.v3,p=e.assetManager /* assetManager */,f=e.Prefab /* Prefab */,g=e.Sprite /* Sprite */,m=e.instantiate /* instantiate */,v=e.find /* find */,y=e.Component /* Component */}
,function(e){
_=e.AudioManager /* AudioManager */}
,function(e){
b=e.GameModel /* GameModel */}
,function(e){
S=e.ResManager /* ResManager */}
,function(e){
C=e.UIConfigTable /* UIConfigTable */}
,function(e){
