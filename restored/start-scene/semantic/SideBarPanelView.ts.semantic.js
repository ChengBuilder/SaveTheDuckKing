/**
 * Semantic view: chunks:///_virtual/SideBarPanelView.ts
...
var t /* applyDecoratedDescriptor */, n /* inheritsLoose */, o /* initializerDefineProperty */, r /* assertThisInitialized */, a /* asyncToGenerator */, s /* cclegacy */, l /* _decorator */, c /* Node */, u /* Button */, d /* SpriteFrame */, h /* tween */, p /* UIOpacity */, f, g /* assetManager */, m /* Prefab */, v /* Sprite */, y /* Component */, _ /* director */, b /* find */, S /* AudioManager */, C /* GameModel */, w /* GameCtrl */, N /* releaseType */, k /* UIConfigTable */, T /* HomeScene */, B /* TooYueManager */;
return{
setters:[function(e){
...
,function(e){
s=e.cclegacy /* cclegacy */,l=e._decorator /* _decorator */,c=e.Node /* Node */,u=e.Button /* Button */,d=e.SpriteFrame /* SpriteFrame */,h=e.tween /* tween */,p=e.UIOpacity /* UIOpacity */,f=e.v3,g=e.assetManager /* assetManager */,m=e.Prefab /* Prefab */,v=e.Sprite /* Sprite */,y=e.Component /* Component */,_=e.director /* director */,b=e.find /* find */}
,function(e){
