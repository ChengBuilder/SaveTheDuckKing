/**
 * Semantic view: chunks:///_virtual/AdManager_WX.ts
...
var t /* createClass */, n /* cclegacy */, i /* resources */, o /* Asset */, r /* director */, a /* find */, s /* GameModel */, l /* releaseType */, c /* Util */, u /* AudioManager */, d /* DuckController */, h /* Game2Controller */;
return{
setters:[function(e){
t=e.createClass /* createClass */}
,function(e){
n=e.cclegacy /* cclegacy */,i=e.resources /* resources */,o=e.Asset /* Asset */,r=e.director /* director */,a=e.find /* find */}
,function(e){
s=e.GameModel /* GameModel */}
,function(e){
l=e.releaseType /* releaseType */}
,function(e){
c=e.Util /* Util */}
,function(e){
u=e.AudioManager /* AudioManager */}
,function(e){
d=e.DuckController /* DuckController */}
,function(e){
h=e.Game2Controller /* Game2Controller */}
],execute:function(){
var p;
n._RF.push({
}
