/**
 * Semantic view: chunks:///_virtual/Nail.ts
...
System.register("chunks:///_virtual/Nail.ts",["./rollupPluginModLoBabelHelpers.js","cc","./ResManager.ts","./GameModel2.ts","./GameCtrl.ts","./Enum.ts","./Util.ts","./DuckController.ts","./AudioManager.ts","./GameData.ts"],(function(e){
  var t /* applyDecoratedDescriptor */, n /* inheritsLoose */, i /* initializerDefineProperty */, o /* assertThisInitialized */, r /* cclegacy */, a /* _decorator */, s /* Node */, l /* Sprite */, c /* UITransform */, u /* instantiate */, d /* UIOpacity */, h, p /* find */, f /* quat */, g /* tween */, m /* RigidBody2D */, v /* CircleCollider2D */, y /* ERigidBody2DType */, _ /* Label */, b /* Contact2DType */, S /* Component */, C /* ResManager */, w /* GameModel */, N /* GameCtrl */, k /* COLLIDER_TAG */, T /* PHY_GROUP */, B /* Util */, A /* DuckController */, P /* AudioManager */, M /* GameData */;
  return{
    setters:[function(e){
    ...
    ,function(e){
      r=e.cclegacy /* cclegacy */,a=e._decorator /* _decorator */,s=e.Node /* Node */,l=e.Sprite /* Sprite */,c=e.UITransform /* UITransform */,u=e.instantiate /* instantiate */,d=e.UIOpacity /* UIOpacity */,h=e.v3,p=e.find /* find */,f=e.quat /* quat */,g=e.tween /* tween */,m=e.RigidBody2D /* RigidBody2D */,v=e.CircleCollider2D /* CircleCollider2D */,y=e.ERigidBody2DType /* ERigidBody2DType */,_=e.Label /* Label */,b=e.Contact2DType /* Contact2DType */,S=e.Component /* Component */}
    ,function(e){
    ...
    ,function(e){
      k=e.COLLIDER_TAG /* COLLIDER_TAG */,T=e.PHY_GROUP /* PHY_GROUP */}
    ,function(e){
      B=e.Util /* Util */}
    ,function(e){
      A=e.DuckController /* DuckController */}
    ,function(e){
