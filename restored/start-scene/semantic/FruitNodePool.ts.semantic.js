/**
 * Semantic view: chunks:///_virtual/FruitNodePool.ts
...
var t /* createForOfIteratorHelperLoose */, n /* cclegacy */, i /* Color */, o /* instantiate */, r /* Sprite */, a /* Tween */, s /* Joint2D */, l /* NodePool */, c /* Component */;
return{
setters:[function(e){
t=e.createForOfIteratorHelperLoose /* createForOfIteratorHelperLoose */}
,function(e){
n=e.cclegacy /* cclegacy */,i=e.Color /* Color */,o=e.instantiate /* instantiate */,r=e.Sprite /* Sprite */,a=e.Tween /* Tween */,s=e.Joint2D /* Joint2D */,l=e.NodePool /* NodePool */,c=e.Component /* Component */}
],execute:function(){
n._RF.push({
}
