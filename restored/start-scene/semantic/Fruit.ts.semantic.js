/**
 * Semantic view: chunks:///_virtual/Fruit.ts
...
var t /* applyDecoratedDescriptor */, n /* inheritsLoose */, i /* initializerDefineProperty */, o /* assertThisInitialized */, r /* cclegacy */, a /* _decorator */, s /* Node */, l, c, u /* RigidBody2D */, d /* PolygonCollider2D */, h /* Tween */, p /* Vec3 */, f /* CircleCollider2D */, g /* UITransform */, m /* ERigidBody2DType */, v /* tween */, y /* find */, _ /* Contact2DType */, b /* Sprite */, S /* Color */, C /* Component */, w /* GameCtrl */, N /* AudioManager */, k /* default */, T /* GAME2_EVENT_KEYS */, B /* COLLIDER_TAG */, A /* Util */, P /* Game2Controller */, M /* AdManager */, I /* GameData2 */, F /* GameModel */, R /* FruitHole */;
return{
setters:[function(e){
...
,function(e){
r=e.cclegacy /* cclegacy */,a=e._decorator /* _decorator */,s=e.Node /* Node */,l=e.v3,c=e.v2,u=e.RigidBody2D /* RigidBody2D */,d=e.PolygonCollider2D /* PolygonCollider2D */,h=e.Tween /* Tween */,p=e.Vec3 /* Vec3 */,f=e.CircleCollider2D /* CircleCollider2D */,g=e.UITransform /* UITransform */,m=e.ERigidBody2DType /* ERigidBody2DType */,v=e.tween /* tween */,y=e.find /* find */,_=e.Contact2DType /* Contact2DType */,b=e.Sprite /* Sprite */,S=e.Color /* Color */,C=e.Component /* Component */}
,function(e){
...
k=e.default /* default */}
,function(e){
T=e.GAME2_EVENT_KEYS /* GAME2_EVENT_KEYS */,B=e.COLLIDER_TAG /* COLLIDER_TAG */}
,function(e){
A=e.Util /* Util */}
,function(e){
P=e.Game2Controller /* Game2Controller */}
,function(e){
M=e.AdManager /* AdManager */}
,function(e){
I=e.GameData2 /* GameData2 */}
,function(e){
F=e.GameModel /* GameModel */}
,function(e){
R=e.FruitHole /* FruitHole */}
],execute:function(){
var L,x,D,G,E,O,H;
r._RF.push({
}
