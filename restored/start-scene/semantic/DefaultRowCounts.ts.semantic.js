/**
 * Semantic view: chunks:///_virtual/DefaultRowCounts.ts
...
System.register("chunks:///_virtual/DefaultRowCounts.ts",["cc","./BoardLayout.ts"],(function(e){
  var t /* cclegacy */, n /* maxFruitsPerRowFullScreenMessy */, i /* maxFruitsPerRowWithSlotGap */;
  return{
    setters:[function(e){
      t=e.cclegacy /* cclegacy */}
    ,function(e){
      n=e.maxFruitsPerRowFullScreenMessy /* maxFruitsPerRowFullScreenMessy */,i=e.maxFruitsPerRowWithSlotGap /* maxFruitsPerRowWithSlotGap */}
    ],execute:function(){
      function o(e){
