/**
 * Semantic view: chunks:///_virtual/SetBtnView.ts
...
System.register("chunks:///_virtual/SetBtnView.ts",["./rollupPluginModLoBabelHelpers.js","cc","./AudioManager.ts","./ResManager.ts","./GameCtrl.ts","./ConfigTable.ts","./GameModel2.ts"],(function(e){
  var t /* inheritsLoose */, n /* cclegacy */, i /* _decorator */, o /* director */, r /* instantiate */, a /* find */, s /* Node */, l /* Component */, c /* AudioManager */, u /* ResManager */, d /* GameCtrl */, h /* UIConfigTable */, p /* GameModel */;
  return{
    setters:[function(e){
      t=e.inheritsLoose /* inheritsLoose */}
    ,function(e){
      n=e.cclegacy /* cclegacy */,i=e._decorator /* _decorator */,o=e.director /* director */,r=e.instantiate /* instantiate */,a=e.find /* find */,s=e.Node /* Node */,l=e.Component /* Component */}
    ,function(e){
      c=e.AudioManager /* AudioManager */}
    ,function(e){
      u=e.ResManager /* ResManager */}
    ,function(e){
