/**
 * Semantic view: chunks:///_virtual/FruitManager.ts
...
System.register("chunks:///_virtual/FruitManager.ts",["./rollupPluginModLoBabelHelpers.js","cc","./Util.ts","./GameModel2.ts","./Fruit.ts","./ResManager.ts","./GameCtrl.ts","./Game2Controller.ts","./EventManager.ts","./Enum.ts","./PoolManager.ts","./GameData2.ts","./GridManager.ts","./FruitHole.ts"],(function(e){
  var t /* inheritsLoose */, n /* asyncToGenerator */, o /* cclegacy */, r /* _decorator */, a /* view */, s /* find */, l, c /* Sprite */, u /* UIOpacity */, d /* Vec3 */, h, p /* Component */, f, g /* Util */, m /* GameModel */, v /* Fruit */, y /* ResManager */, _ /* GameCtrl */, b /* Game2Controller */, S /* default */, C /* GAME2_EVENT_KEYS */, w /* PoolManager */, N /* GameData2 */, k /* GridManager */, T /* FruitHole */;
  return{
    setters:[function(e){
      t=e.inheritsLoose /* inheritsLoose */,n=e.asyncToGenerator /* asyncToGenerator */}
    ,function(e){
      o=e.cclegacy /* cclegacy */,r=e._decorator /* _decorator */,a=e.view /* view */,s=e.find /* find */,l=e.v3,c=e.Sprite /* Sprite */,u=e.UIOpacity /* UIOpacity */,d=e.Vec3 /* Vec3 */,h=e.v2,p=e.Component /* Component */,f=e.sp}
    ,function(e){
      g=e.Util /* Util */}
    ,function(e){
      m=e.GameModel /* GameModel */}
    ,function(e){
      v=e.Fruit /* Fruit */}
    ,function(e){
      y=e.ResManager /* ResManager */}
    ,function(e){
      _=e.GameCtrl /* GameCtrl */}
    ,function(e){
      b=e.Game2Controller /* Game2Controller */}
    ,function(e){
      S=e.default /* default */}
    ,function(e){
      C=e.GAME2_EVENT_KEYS /* GAME2_EVENT_KEYS */}
    ,function(e){
      w=e.PoolManager /* PoolManager */}
    ,function(e){
      N=e.GameData2 /* GameData2 */}
    ,function(e){
      k=e.GridManager /* GridManager */}
    ,function(e){
      T=e.FruitHole /* FruitHole */}
    ],execute:function(){
      var B;
      o._RF.push({
      }
