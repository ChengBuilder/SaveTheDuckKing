/**
 * Semantic view: chunks:///_virtual/Wood.ts
...
var t /* inheritsLoose */, n /* cclegacy */, i /* _decorator */, o /* PolygonCollider2D */, r /* RigidBody2D */, a /* find */, s /* UITransform */, l /* tween */, c /* Sprite */, u /* Color */, d /* instantiate */, h /* UIOpacity */, p /* ERigidBody2DType */, f /* HingeJoint2D */, g, m /* Node */, v /* Component */, y /* Util */, _ /* GameModel */, b /* PHY_GROUP */, S /* Nail */, C /* ResManager */, w /* DuckController */, N /* AudioManager */, k /* GameData */;
return{
setters:[function(e){
t=e.inheritsLoose /* inheritsLoose */}
,function(e){
n=e.cclegacy /* cclegacy */,i=e._decorator /* _decorator */,o=e.PolygonCollider2D /* PolygonCollider2D */,r=e.RigidBody2D /* RigidBody2D */,a=e.find /* find */,s=e.UITransform /* UITransform */,l=e.tween /* tween */,c=e.Sprite /* Sprite */,u=e.Color /* Color */,d=e.instantiate /* instantiate */,h=e.UIOpacity /* UIOpacity */,p=e.ERigidBody2DType /* ERigidBody2DType */,f=e.HingeJoint2D /* HingeJoint2D */,g=e.v2,m=e.Node /* Node */,v=e.Component /* Component */}
,function(e){
y=e.Util /* Util */}
,function(e){
_=e.GameModel /* GameModel */}
,function(e){
b=e.PHY_GROUP /* PHY_GROUP */}
,function(e){
S=e.Nail /* Nail */}
,function(e){
C=e.ResManager /* ResManager */}
,function(e){
w=e.DuckController /* DuckController */}
,function(e){
N=e.AudioManager /* AudioManager */}
,function(e){
k=e.GameData /* GameData */}
],execute:function(){
var T;
n._RF.push({
}
