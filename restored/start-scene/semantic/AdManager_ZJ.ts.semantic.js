/**
 * Semantic view: chunks:///_virtual/AdManager_ZJ.ts
...
var t /* extends */, n /* createForOfIteratorHelperLoose */, o /* createClass */, r /* asyncToGenerator */, a /* cclegacy */, s /* director */, l /* find */, c /* Util */, u /* releaseType */, d /* GameModel */, h /* DuckController */, p /* TooYueManager */, f /* Game2Controller */;
return{
setters:[function(e){
t=e.extends /* extends */,n=e.createForOfIteratorHelperLoose /* createForOfIteratorHelperLoose */,o=e.createClass /* createClass */,r=e.asyncToGenerator /* asyncToGenerator */}
,function(e){
a=e.cclegacy /* cclegacy */,s=e.director /* director */,l=e.find /* find */}
,function(e){
c=e.Util /* Util */}
,function(e){
u=e.releaseType /* releaseType */}
,function(e){
d=e.GameModel /* GameModel */}
,function(e){
h=e.DuckController /* DuckController */}
,function(e){
