/**
 * Semantic view: chunks:///_virtual/GameCtl.ts
...
var t /* createForOfIteratorHelperLoose */, n /* cclegacy */, i /* RigidBody2D */, o /* ERigidBody2DType */, r /* Vec2 */, a /* Vec3 */, s /* tween */, l /* Node */, c /* UITransform */, u /* Tween */, d /* easing */, h /* math */, p /* Color */, f /* shuffleInPlace */, g /* maxSlotsForRow */, m /* ROW_HOLE_BOARD_ID_BASE */, v /* GameModel */, y /* LevelMechanismManager */, _ /* resolveFixedShapeFromNodeMarkers */, b /* CollisionUtil */, S /* ROPE_MAX_LINK_DIST */, C /* tryPickFirstValidRopePath */, w /* ROPE_POINT_RADIUS */, N /* AdManager */, k /* GameCtrl */, T /* TooYueManager */, B /* AudioManager */;
return{
setters:[function(e){
t=e.createForOfIteratorHelperLoose /* createForOfIteratorHelperLoose */}
,function(e){
n=e.cclegacy /* cclegacy */,i=e.RigidBody2D /* RigidBody2D */,o=e.ERigidBody2DType /* ERigidBody2DType */,r=e.Vec2 /* Vec2 */,a=e.Vec3 /* Vec3 */,s=e.tween /* tween */,l=e.Node /* Node */,c=e.UITransform /* UITransform */,u=e.Tween /* Tween */,d=e.easing /* easing */,h=e.math /* math */,p=e.Color /* Color */}
,function(e){
f=e.shuffleInPlace /* shuffleInPlace */}
,function(e){
g=e.maxSlotsForRow /* maxSlotsForRow */}
,function(e){
m=e.ROW_HOLE_BOARD_ID_BASE /* ROW_HOLE_BOARD_ID_BASE */,v=e.GameModel /* GameModel */}
,function(e){
y=e.LevelMechanismManager /* LevelMechanismManager */,_=e.resolveFixedShapeFromNodeMarkers /* resolveFixedShapeFromNodeMarkers */}
,function(e){
b=e.CollisionUtil /* CollisionUtil */}
,function(e){
S=e.ROPE_MAX_LINK_DIST /* ROPE_MAX_LINK_DIST */,C=e.tryPickFirstValidRopePath /* tryPickFirstValidRopePath */,w=e.ROPE_POINT_RADIUS /* ROPE_POINT_RADIUS */}
,function(e){
