/**
 * Semantic view: chunks:///_virtual/RopeGenerator.ts
...
System.register("chunks:///_virtual/RopeGenerator.ts",["./rollupPluginModLoBabelHelpers.js","cc","./CollisionUtil.ts"],(function(e){
  var t /* createForOfIteratorHelperLoose */, n /* cclegacy */, i /* Vec2 */, o /* CollisionUtil */;
  return{
    setters:[function(e){
      t=e.createForOfIteratorHelperLoose /* createForOfIteratorHelperLoose */}
    ,function(e){
      n=e.cclegacy /* cclegacy */,i=e.Vec2 /* Vec2 */}
    ,function(e){
      o=e.CollisionUtil /* CollisionUtil */}
    ],execute:function(){
      e({
