/**
 * Semantic view: chunks:///_virtual/PowerBox.ts
...
System.register("chunks:///_virtual/PowerBox.ts",["./rollupPluginModLoBabelHelpers.js","cc","./ConfigTable.ts","./GameModel2.ts","./GameCtrl.ts","./AudioManager.ts","./ResManager.ts"],(function(e){
  var t /* inheritsLoose */, n /* cclegacy */, i /* _decorator */, o /* Node */, r /* assetManager */, a /* Prefab */, s /* Label */, l /* Button */, c /* instantiate */, u /* find */, d /* Component */, h /* UIConfigTable */, p /* GameModel */, f /* GameCtrl */, g /* AudioManager */, m /* ResManager */;
  return{
    setters:[function(e){
      t=e.inheritsLoose /* inheritsLoose */}
    ,function(e){
      n=e.cclegacy /* cclegacy */,i=e._decorator /* _decorator */,o=e.Node /* Node */,r=e.assetManager /* assetManager */,a=e.Prefab /* Prefab */,s=e.Label /* Label */,l=e.Button /* Button */,c=e.instantiate /* instantiate */,u=e.find /* find */,d=e.Component /* Component */}
    ,function(e){
      h=e.UIConfigTable /* UIConfigTable */}
    ,function(e){
      p=e.GameModel /* GameModel */}
    ,function(e){
      f=e.GameCtrl /* GameCtrl */}
    ,function(e){
      g=e.AudioManager /* AudioManager */}
    ,function(e){
      m=e.ResManager /* ResManager */}
    ],execute:function(){
      var v;
      n._RF.push({
      }
