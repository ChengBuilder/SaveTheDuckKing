/**
 * Semantic view: chunks:///_virtual/itemNode.ts
...
System.register("chunks:///_virtual/itemNode.ts",["./rollupPluginModLoBabelHelpers.js","cc","./GameModel2.ts","./ResManager.ts","./Util.ts"],(function(e){
  var t /* applyDecoratedDescriptor */, n /* inheritsLoose */, i /* initializerDefineProperty */, o /* assertThisInitialized */, r /* cclegacy */, a /* _decorator */, s /* Node */, l /* SpriteFrame */, c /* Label */, u /* Sprite */, d /* Color */, h /* Vec3 */, p /* Component */, f /* GameModel */, g /* ResManager */, m /* Util */;
  return{
    setters:[function(e){
    ...
    ,function(e){
      r=e.cclegacy /* cclegacy */,a=e._decorator /* _decorator */,s=e.Node /* Node */,l=e.SpriteFrame /* SpriteFrame */,c=e.Label /* Label */,u=e.Sprite /* Sprite */,d=e.Color /* Color */,h=e.Vec3 /* Vec3 */,p=e.Component /* Component */}
    ,function(e){
      f=e.GameModel /* GameModel */}
    ,function(e){
      g=e.ResManager /* ResManager */}
    ,function(e){
      m=e.Util /* Util */}
    ],execute:function(){
