/**
 * Semantic view: chunks:///_virtual/BookPigeonPanelView.ts
...
System.register("chunks:///_virtual/BookPigeonPanelView.ts",["./rollupPluginModLoBabelHelpers.js","cc","./AudioManager.ts","./GameModel2.ts","./ResManager.ts","./GameCtrl.ts","./ConfigTable.ts","./HomeScene.ts","./itemPigeonNode.ts","./TooYueManager.ts","./ServiceManager.ts"],(function(e){
  var t /* applyDecoratedDescriptor */, n /* inheritsLoose */, o /* initializerDefineProperty */, r /* assertThisInitialized */, a /* asyncToGenerator */, s /* cclegacy */, l /* _decorator */, c /* Node */, u /* Button */, d /* ScrollView */, h /* assetManager */, p /* Prefab */, f /* UIOpacity */, g /* instantiate */, m, v /* Vec3 */, y /* tween */, _ /* Tween */, b /* director */, S /* find */, C /* Component */, w /* NodePool */, N /* UITransform */, k /* AudioManager */, T /* GameModel */, B /* ResManager */, A /* GameCtrl */, P /* UIConfigTable */, M /* HomeScene */, I /* itemPigeonNode */, F /* TooYueManager */, R /* default */;
  return{
    setters:[function(e){
    ...
    ,function(e){
      s=e.cclegacy /* cclegacy */,l=e._decorator /* _decorator */,c=e.Node /* Node */,u=e.Button /* Button */,d=e.ScrollView /* ScrollView */,h=e.assetManager /* assetManager */,p=e.Prefab /* Prefab */,f=e.UIOpacity /* UIOpacity */,g=e.instantiate /* instantiate */,m=e.v3,v=e.Vec3 /* Vec3 */,y=e.tween /* tween */,_=e.Tween /* Tween */,b=e.director /* director */,S=e.find /* find */,C=e.Component /* Component */,w=e.NodePool /* NodePool */,N=e.UITransform /* UITransform */}
    ,function(e){
      k=e.AudioManager /* AudioManager */}
    ,function(e){
      T=e.GameModel /* GameModel */}
    ,function(e){
      B=e.ResManager /* ResManager */}
    ,function(e){
      A=e.GameCtrl /* GameCtrl */}
    ,function(e){
      P=e.UIConfigTable /* UIConfigTable */}
    ,function(e){
      M=e.HomeScene /* HomeScene */}
    ,function(e){
      I=e.itemPigeonNode /* itemPigeonNode */}
    ,function(e){
