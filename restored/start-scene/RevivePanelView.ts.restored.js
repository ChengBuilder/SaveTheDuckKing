...
System.register("chunks:///_virtual/RevivePanelView.ts",["./rollupPluginModLoBabelHelpers.js","cc","./GameModel2.ts","./AudioManager.ts","./EventManager.ts","./Enum.ts","./GameCtrl.ts","./Util.ts","./DuckController.ts","./ConfigTable.ts","./TooYueManager.ts","./AutoManager.ts","./Game2Controller.ts","./ResManager.ts","./Game.ts"],(function(e){
  var t,n,i,o,r,a,s,l,c,u,d,h,p,f,g,m,v,y,_,b,S,C,w,N,k,T,B,A,P,M,I,F,R,L,x;
  return{
    setters:[function(e){
      t=e.applyDecoratedDescriptor,n=e.inheritsLoose,i=e.initializerDefineProperty,o=e.assertThisInitialized}
    ,function(e){
      r=e.cclegacy,a=e._decorator,s=e.Node,l=e.Button,c=e.Label,u=e.SpriteFrame,d=e.UIOpacity,h=e.Sprite,p=e.tween,f=e.v3,g=e.director,m=e.find,v=e.ProgressBar,y=e.assetManager,_=e.Prefab,b=e.Component}
    ,function(e){
      S=e.GameModel}
    ,function(e){
      C=e.AudioManager}
