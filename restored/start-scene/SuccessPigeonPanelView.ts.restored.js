...
System.register("chunks:///_virtual/SuccessPigeonPanelView.ts",["./rollupPluginModLoBabelHelpers.js","cc","./GameModel2.ts","./AudioManager.ts","./Enum.ts","./EventManager.ts","./GameCtrl.ts","./ConfigTable.ts","./Util.ts","./ResManager.ts","./TooYueManager.ts","./AdManager_ZJ.ts","./AddTablePanelView.ts","./AutoManager.ts"],(function(e){
  var t,n,i,o,r,a,s,l,c,u,d,h,p,f,g,m,v,y,_,b,S,C,w,N,k,T,B,A,P,M,I,F;
  return{
    setters:[function(e){
      t=e.applyDecoratedDescriptor,n=e.inheritsLoose,i=e.initializerDefineProperty,o=e.assertThisInitialized}
    ,function(e){
      r=e.cclegacy,a=e._decorator,s=e.Node,l=e.Button,c=e.find,u=e.v2,d=e.v3,h=e.tween,p=e.instantiate,f=e.UIOpacity,g=e.UITransform,m=e.Tween,v=e.assetManager,y=e.Prefab,_=e.Component}
    ,function(e){
      b=e.GameModel}
    ,function(e){
      S=e.AudioManager}
