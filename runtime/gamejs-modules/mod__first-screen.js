...
// Source: source-project/runtime-modules/first-screen.js
define("runtime/gamejs-modules/first-screen.js", function (require, module, exports) {
  "use strict";
        ...
        module.exports = {
          start: function (n, t, o) {
            ...
            return (
              ...
              (s = 2 / canvas.width),
              (f = 2 / canvas.height),
              (_ = new Float32Array([s, f + 0.225, 1, 1, s, f + 0.225, 1, 0, -s, f + 0.225, 0, 1, -s, f + 0.225, 0, 0])),
              (l = r.createBuffer()),
              ...
              (function () {
                var e = ((window.devicePixelRatio >= 2 ? 6 : 3) / canvas.height) * 1.35,
                  n = new Float32Array([0.5, -0.8 - e, 1, 0.5, -0.8 + e, 1, -0.5, -0.8 - e, 0, -0.5, -0.8 + e, 0]);
