...
// Source: source-project/runtime-modules/assets/internal/index.internal.js
define("runtime/gamejs-modules/assets/internal/index.internal.js", function (require, module, exports) {
  "use strict";
                          ...
                          (s.start = function () {
                            if (this.node.parent.getComponent(g)) {
                              ...
                              (i += 200),
                                ...
                                this.EnableAllCompositeModeButton.on(C.EventType.CLICK, this.enableAllCompositeMode, this),
                              ...
                              for (var I = 0; I < this.strMisc.length; I++) {
                                ...
                                y.setPosition(i, n - 20 * I, 0), y.setScale(0.5, 0.5, 0.5), (y.parent = s);
