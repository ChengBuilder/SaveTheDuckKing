...
define("runtime/gamejs-modules/subpackages-bootstrap.js", function (require, module, exports) {
  "use strict";
  (function () {
    "use strict";
    var e, t;
    ...
    System.register("chunks:///_virtual/MultTextures.ts", ["cc", "./env"], function (t) {
      ...
      return {
        ...
        execute: function () {
          ...
          var T = function () {
              (m.enable = !1),
                f.load("multiTexture/multiTextureMaterial", a, function (t, r) {
                  if (!t) {
                ...
                (t.isMult = !1),
                  ...
                  (t.commitComp = function (t, e, r, a, i) {
                    ...
                    if (
                      ...
                      if (h < 0 || 0 === f.count) {
                        ...
                        D[h] !== c &&
                          ((D[h] = c), (c = r.texture) || (c = r), this._currMaterial.setProperty("texture" + h, c));
                      }
                  ...
                  (t.fillTextureID = function (t, e) {
                    var r = t.chunk.vb,
                      ...
                      i = r.length;
                    if (1 === t.dataDirty)
                      for (var s = 0; s < i; s += 9) (a = ~~(1e5 * r[s + 3])), (r[s + 3] = 10 * a + e);
                    else if (t.texID !== e)
                      for (var n = 0; n < i; n += 9) (a = ~~(0.1 * r[n + 3])), (r[n + 3] = 10 * a + e);
