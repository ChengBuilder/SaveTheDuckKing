...
!(function e(t, n, r) {
...
})(
  {
      ...
      function (e, t, n) {
        ...
        ((r.prototype.parseFromString = function (e, t) {
          ...
          return (
            ...
            t && (f[''] = 'http://www.w3.org/1999/xhtml'),
            (f.xml = f.xml || 'http://www.w3.org/XML/1998/namespace'),
            e ? r.parse(e, f, d) : r.errorHandler.error('invalid doc source'),
            i.doc
          );
        }),
          (o.prototype = {
            ...
            startElement: function (e, t, n, r) {
              ...
              for (var l = 0; l < u; l++) {
                ...
                (this.locator && i(r.getLocator(l), f),
                  (f.value = f.nodeValue = s),
            ...
            characters: function (e, t, n) {
              ...
              (e = u.apply(this, arguments)) &&
                ((r = this.cdata ? this.doc.createCDATASection(e) : this.doc.createTextNode(e)),
                this.currentElement
            ...
            startDTD: function (e, t, n) {
              ...
              r &&
                r.createDocumentType &&
                ((r = r.createDocumentType(e, t, n)),
    ...
    2: [
      function (t, n, r) {
        ...
        function a(e, t) {
          ...
          n.constructor != e &&
            ('function' != typeof e && console.error('unknow Class:' + e), (n.constructor = e));
        }
        var u,
          c = {},
          l =
        ...
        function y(e, t, n, r) {
          (r ? (t[E(t, r)] = n) : (t[t.length++] = n),
            e &&
              ...
              (r._nsMap[e.prefix ? e.localName : ''] = e.value));
        }
        function b(e, t, n) {
          var r = E(t, n);
        ...
        function k(e, t) {
          ...
          return (
            X(
              ...
              t,
              (n =
                a && null == i && null == o.lookupPrefix(a) ? [{ namespace: a, prefix: null }] : n)
            ),
            r.join('')
          );
        }
        ...
        function X(e, t, n, r, o) {
          ...
          switch (e.nodeType) {
            case 1:
              ...
              for (var l = 0; l < a; l++)
                'xmlns' == (s = i.item(l)).prefix
                  ? o.push({ prefix: s.localName, namespace: s.value })
              ...
              for (l = 0; l < a; l++)
                (G((s = i.item(l)), 0, o) &&
                  ((f = s.prefix || ''),
                  (d = s.namespaceURI),
                  t.push(f ? ' xmlns:' + f : ' xmlns', '="', d, '"'),
                  o.push({ prefix: f, namespace: d })),
                  X(s, t, n, r, o));
              if (
                (G(e, 0, o) &&
                  ((f = e.prefix || ''),
                ...
                else for (; u; ) (X(u, t, n, r, o), (u = u.nextSibling));
                t.push('</', c, '>');
              } else t.push('/>');
              return;
            case 9:
            ...
            case 10:
              ...
              return (
                ...
                void (c
                  ? (t.push(' PUBLIC "', c), p && '.' != p && t.push('" "', p), t.push('">'))
                  : p && '.' != p
                    ? t.push(' SYSTEM "', p, '">')
                    : ((c = e.internalSubset) && t.push(' [', c, ']'), t.push('>')))
              );
            case 7:
        ...
        ((l.INDEX_SIZE_ERR = ((s[1] = 'Index size error'), 1)),
          (l.DOMSTRING_SIZE_ERR = ((s[2] = 'DOMString size error'), 2)),
          (l.HIERARCHY_REQUEST_ERR = ((s[3] = 'Hierarchy request error'), 3)),
          (l.WRONG_DOCUMENT_ERR = ((s[4] = 'Wrong document'), 4)),
          (l.INVALID_CHARACTER_ERR = ((s[5] = 'Invalid character'), 5)),
          (l.NO_DATA_ALLOWED_ERR = ((s[6] = 'No data allowed'), 6)),
          (l.NO_MODIFICATION_ALLOWED_ERR = ((s[7] = 'No modification allowed'), 7)),
          (l.NOT_FOUND_ERR = ((s[8] = 'Not found'), 8)),
          (l.NOT_SUPPORTED_ERR = ((s[9] = 'Not supported'), 9)),
          (l.INUSE_ATTRIBUTE_ERR = ((s[10] = 'Attribute in use'), 10)),
          (l.INVALID_STATE_ERR = ((s[11] = 'Invalid state'), 11)),
          (l.SYNTAX_ERR = ((s[12] = 'Syntax error'), 12)),
          (l.INVALID_MODIFICATION_ERR = ((s[13] = 'Invalid modification'), 13)),
          (l.NAMESPACE_ERR = ((s[14] = 'Invalid namespace'), 14)),
          (l.INVALID_ACCESS_ERR = ((s[15] = 'Invalid access'), 15)),
          ...
          (v.prototype = {
            ...
            createDocument: function (e, t, n) {
              ...
              return (
                ...
                t && ((n = r.createElementNS(e, t)), r.appendChild(n)),
                r
              );
            },
          ...
          (_.prototype = {
            ...
            cloneNode: function (e) {
              return (function e(t, n, r) {
                ...
                switch (
                  (n.childNodes && (i.childNodes = new d()), (i.ownerDocument = t), i.nodeType)
                ) {
                  case 1:
                    var c = n.attributes,
          ...
          (w.prototype = {
            ...
            insertBefore: function (e, t) {
              if (11 == e.nodeType)
                ...
                (null == this.documentElement && 1 == e.nodeType && (this.documentElement = e),
                  A(this, e, t),
          ...
          a(w, _),
          (w.prototype.getElementsByTagName = (O.prototype = {
            nodeType: 1,
            ...
            appendChild: function (e) {
              return 11 === e.nodeType
                ...
                : ((t = this),
                  (n = (e = e).parentNode) &&
                    ((r = t.lastChild), n.removeChild(e), (r = t.lastChild)),
                  (r = t.lastChild),
                  (e.parentNode = t),
                  (e.previousSibling = r),
                  (e.nextSibling = null),
            ...
            setAttributeNS: function (e, t, n) {
              (((e = this.ownerDocument.createAttributeNS(e, t)).value = e.nodeValue = '' + n),
                this.setAttributeNode(e));
            },
          ...
          (w.prototype.getElementsByTagNameNS = O.prototype.getElementsByTagNameNS),
          a(O, _),
          (P.prototype.nodeType = 2),
          a(P, _),
          (I.prototype = {
            data: '',
          ...
          a(M, I),
          (C.prototype = { nodeName: '#comment', nodeType: 8 }),
          a(C, I),
          (D.prototype = { nodeName: '#cdata-section', nodeType: 4 }),
          a(D, I),
          (L.prototype.nodeType = 10),
          a(L, _),
          (x.prototype.nodeType = 12),
          a(x, _),
          (j.prototype.nodeType = 6),
          a(j, _),
          (U.prototype.nodeType = 5),
          a(U, _),
          (F.prototype.nodeName = '#document-fragment'),
          (F.prototype.nodeType = 11),
          a(F, _),
          (B.prototype.nodeType = 7),
          a(B, _),
          (H.prototype.serializeToString = function (e, t, n) {
            return k.call(e, t, n);
          }),
    ...
    4: [
      function (e, t, n) {
        var r =
          ...
          o = new RegExp(
            '[\\-\\.0-9' + r.source.slice(1, -1) + '\\u00B7\\u0300-\\u036F\\u203F-\\u2040]'
          ),
        ...
        function c(e, t, n) {
          for (var r = e.tagName, o = null, i = e.length; i--; ) {
            ...
            u =
              0 < (f = u.indexOf(':'))
                ? ((s = a.prefix = u.slice(0, f)), (d = u.slice(f + 1)), 'xmlns' === s && d)
                : ((s = null), 'xmlns' === (d = u) && '');
            ((a.localName = d),
              !1 !== u &&
                (null == o && ((o = {}), l(n, (n = {}))),
          ...
          for (i = e.length; i--; )
            (s = (a = e[i]).prefix) &&
              ('xml' === s && (a.uri = 'http://www.w3.org/XML/1998/namespace'), 'xmlns' !== s) &&
              (a.uri = n[s || '']);
          var f,
            d =
              0 < (f = r.indexOf(':'))
                ? ((s = e.prefix = r.slice(0, f)), (e.localName = r.slice(f + 1)))
                : ((s = null), (e.localName = r)),
            p = (e.uri = n[s || '']);
          if ((t.startElement(p, d, r, e), !e.closed))
            return ((e.currentNSMap = n), (e.localNSMap = o), 1);
          if ((t.endElement(p, d, r), o)) for (s in o) t.endPrefixMapping(s);
        }
        function l(e, t) {
          for (var n in e) t[n] = e[n];
        }
            ...
            (r.startDocument(),
              ...
              (function (e, t, n, r, o) {
                ...
                function a(t) {
                  var n;
                  y < t &&
                    ((n = e.substring(y, t).replace(/&#?\w+;/g, i)),
                    m && l(y),
                    r.characters(n, 0, t - y),
                    (y = t));
                }
                function l(t, n) {
                  for (; d <= t && (n = p.exec(e)); )
                    ((f = n.index), (d = f + n[0].length), m.lineNumber++);
                ...
                for (
                  ...
                  try {
                    ...
                    if (_ < 0)
                      return (
                        e.substr(y).match(/^\s*$/) ||
                        ((v = (b = r.doc).createTextNode(e.substr(y))),
                        b.appendChild(v),
                        (r.currentElement = v))
                      );
                    switch ((y < _ && a(_), e.charAt(_ + 1))) {
                      case '/':
                        var T = e.indexOf('>', _ + 3),
                          ...
                          N =
                            (T < 0
                              ? ((g = e.substring(_ + 2).replace(/[\s<].*/, '')),
                                o.error('end tag name: ' + g + ' is not complete:' + w.tagName),
                                (T = _ + 1 + g.length))
                              : g.match(/\s</) &&
                                ((g = g.replace(/[\s<].*/, '')),
                                o.error('end tag name: ' + g + ' maybe not complete'),
                                (T = _ + 1 + g.length)),
                            w.localNSMap),
                          S = w.tagName == g;
                      ...
                      case '?':
                        (m && l(_),
                          (T = (function (e, t, n) {
                            var r = e.indexOf('?>', t);
                            return r && (e = e.substring(t, r).match(/^<\?(\S*)\s*([\s\S]*?)\s*$/))
                              ? (e[0].length, n.processingInstruction(e[1], e[2]), r + 2)
                              : -1;
                          })(e, _, r)));
                        break;
                      case '!':
                        (m && l(_),
                          (T = (function (e, t, n, r) {
                            ...
                            return 1 < i && /!doctype/i.test(r[0][0])
                              ? ((e = r[1][0]),
                                (t = 3 < i && /^public$/i.test(r[2][0]) && r[3][0]),
                                (o = 4 < i && r[4][0]),
                                (r = r[i - 1]),
                                n.startDTD(
                                  e,
                      ...
                      default:
                        ...
                        if (
                          (!A.closed &&
                            ...
                            ((A.closed = !0), n.nbsp || o.warning('unclosed xml attribute')),
                          m && P)
                        ) {
                        ...
                        'http://www.w3.org/1999/xhtml' !== A.uri || A.closed
                          ? T++
                          : (T = (function (e, t, n, r, o) {
                              if (/^(?:script|textarea)$/i.test(n)) {
                                ...
                                if (/[&<]/.test(e))
                                  return (
                                    /^script$/i.test(n) || (e = e.replace(/&#?\w+;/g, r)),
                                    o.characters(e, 0, e.length),
                                    i
                                  );
                              }
                              return t + 1;
    ...
    5: [
      function (t, n, r) {
          ...
          return (a =
            'undefined' != typeof Reflect && Reflect.get
              ...
              : function (e, t, n) {
                  ...
                  if (r)
                    return (r = Object.getOwnPropertyDescriptor(r, t)).get
        ...
        (Object.defineProperty(r, '__esModule', { value: !0 }),
          (r.default = void 0),
          (t = (t = t('./HTMLAudioElement')) && t.__esModule ? t : { default: t }));
        var s = 1,
          f = {};
        t = (function (e) {
          var t = r;
          ...
          function r(e) {
            ...
            (((t = n.call(this))._$sn = s++),
              (t.HAVE_NOTHING = 0),
              (t.HAVE_METADATA = 1),
              (t.HAVE_CURRENT_DATA = 2),
              (t.HAVE_FUTURE_DATA = 3),
              (t.HAVE_ENOUGH_DATA = 4),
              (t.readyState = 0));
            ...
            return (
              ...
              o.onCanplay(function () {
                ((t._loaded = !0),
                  ...
                  t._canplayEvents.forEach(function (e) {
              ...
              o.onEnded(function () {
                ((t._paused = f[t._$sn].paused),
                  !1 === f[t._$sn].loop && t.dispatchEvent({ type: 'ended' }),
                  (t.readyState = 4));
              }),
              o.onError(function () {
            ...
            (e = [
              {
                ...
                value: function (e, t) {
                  ...
                  (a(l(r.prototype), 'addEventListener', this).call(this, e, t, n),
                    (e = String(e).toLowerCase()),
                    this._loaded &&
                      -1 !== this._canplayEvents.indexOf(e) &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return 'string' == typeof e &&
                    (-1 < e.indexOf('audio/mpeg') || e.indexOf('audio/mp4'))
                    ? 'probably'
                    : '';
                }
              },
          ...
          (n.default = function () {
            ...
            return (
              ...
              (e.addEventListener = function (e, t) {
                var n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {};
                ('function' == typeof getApp ? GameGlobal.document : document).addEventListener(
                  e,
                  t,
                  n
                );
              ...
              (e.removeEventListener = function (e, t) {
                ('function' == typeof getApp ? GameGlobal.document : document).removeEventListener(
                  e,
                  t
                );
              }),
        ...
        function a(e) {
          ...
          return function () {
            var n,
              r = c(e);
            ((n = t
              ? ((n = c(this).constructor), Reflect.construct(r, arguments, n))
              : r.apply(this, arguments)),
              (r = this));
            if (n && ('object' === o(n) || 'function' == typeof n)) return n;
            if (void 0 !== n)
          ...
          (t = (function (e) {
            ...
            function r() {
              ...
              if (this instanceof r)
                return (l(u((e = n.call(this))), 'className', ''), l(u(e), 'children', []), e);
              throw new TypeError('Cannot call a class as a function');
            }
            return ((t = r), Object.defineProperty(t, 'prototype', { writable: !1 }), t);
          })(((t = t('./Node')) && t.__esModule ? t : { default: t }).default)),
          (r.default = t));
      },
      { './Node': 21 }
    ],
      ...
      function (t, n, r) {
        ...
        var l = (function (e, t, n) {
          ...
          (u(this, 'touches', []),
            ...
            u(this, 'changedTouches', []),
            u(this, 'preventDefault', o.noop),
            u(this, 'stopPropagation', o.noop),
            (this.type = t),
        ...
        function s(e) {
          return function (t) {
            ...
            ((n.touches = t.touches),
              ...
              ('function' == typeof getApp ? GameGlobal.document : document).dispatchEvent(n));
          };
        }
        ((r.default = l),
    ...
    12: [
      function (t, n, r) {
        ...
        var a = (function () {
          ...
          return (
            (t = e),
            (n = [{ key: 'construct', value: function () {} }]) && i(t.prototype, n),
            Object.defineProperty(t, 'prototype', { writable: !1 }),
            e
          );
        })();
      ...
      function (t, n, r) {
        ...
        function a(e) {
          ...
          return function () {
            var n,
              r = u(e);
            ((n = t
              ? ((n = u(this).constructor), Reflect.construct(r, arguments, n))
              : r.apply(this, arguments)),
              (r = this));
            if (n && ('object' === o(n) || 'function' == typeof n)) return n;
            if (void 0 !== n)
        ...
        (Object.defineProperty(r, '__esModule', { value: !0 }),
          ...
          (t = (function (e) {
            ...
            return ((t = r), Object.defineProperty(t, 'prototype', { writable: !1 }), t);
          })(((t = t('./HTMLMediaElement')) && t.__esModule ? t : { default: t }).default)),
          (r.default = t));
      },
      { './HTMLMediaElement': 17 }
    ],
    ...
    15: [
      function (t, n, r) {
        (Object.defineProperty(r, '__esModule', { value: !0 }), (r.default = void 0));
        var o = (o = t('./Element')) && o.__esModule ? o : { default: o },
          i = t('./util/index.js'),
      ...
      { './Element': 7, './WindowProperties': 24, './util/index.js': 31 }
    ],
    16: [
      function (e, t, n) {
    ...
    17: [
      function (t, n, r) {
        ...
        (Object.defineProperty(r, '__esModule', { value: !0 }),
          ...
          })(((t = t('./HTMLElement')) && t.__esModule ? t : { default: t }).default)),
          (r.default = t));
      },
      { './HTMLElement': 15 }
    ],
    ...
    21: [
      function (t, n, r) {
        ...
        (Object.defineProperty(r, '__esModule', { value: !0 }),
          ...
          })(((t = t('./EventTarget.js')) && t.__esModule ? t : { default: t }).default)),
          (r.default = t));
      },
      { './EventTarget.js': 11 }
    ],
    22: [
      function (t, n, r) {
        ...
        (((r.default = a).ACTIVE_ATTRIBUTES = 35721),
          (a.ACTIVE_TEXTURE = 34016),
          (a.ACTIVE_UNIFORMS = 35718),
          (a.ALIASED_LINE_WIDTH_RANGE = 33902),
          (a.ALIASED_POINT_SIZE_RANGE = 33901),
          (a.ALPHA = 6406),
          (a.ALPHA_BITS = 3413),
          (a.ALWAYS = 519),
          (a.ARRAY_BUFFER = 34962),
          (a.ARRAY_BUFFER_BINDING = 34964),
          (a.ATTACHED_SHADERS = 35717),
          (a.BACK = 1029),
          (a.BLEND = 3042),
          (a.BLEND_COLOR = 32773),
          (a.BLEND_DST_ALPHA = 32970),
          (a.BLEND_DST_RGB = 32968),
          (a.BLEND_EQUATION = 32777),
          (a.BLEND_EQUATION_ALPHA = 34877),
          (a.BLEND_EQUATION_RGB = 32777),
          ...
          (a.BOOL_VEC3 = 35672),
          (a.BOOL_VEC4 = 35673),
          (a.BROWSER_DEFAULT_WEBGL = 37444),
          (a.BUFFER_SIZE = 34660),
          (a.BUFFER_USAGE = 34661),
          (a.BYTE = 5120),
          (a.CCW = 2305),
          (a.CLAMP_TO_EDGE = 33071),
          (a.COLOR_ATTACHMENT0 = 36064),
          (a.COLOR_BUFFER_BIT = 16384),
          (a.COLOR_CLEAR_VALUE = 3106),
          (a.COLOR_WRITEMASK = 3107),
          (a.COMPILE_STATUS = 35713),
          (a.COMPRESSED_TEXTURE_FORMATS = 34467),
          (a.CONSTANT_ALPHA = 32771),
          (a.CONSTANT_COLOR = 32769),
          (a.CONTEXT_LOST_WEBGL = 37442),
          (a.CULL_FACE = 2884),
          (a.CULL_FACE_MODE = 2885),
          (a.CURRENT_PROGRAM = 35725),
          (a.CURRENT_VERTEX_ATTRIB = 34342),
          (a.CW = 2304),
          (a.DECR = 7683),
          (a.DECR_WRAP = 34056),
          (a.DELETE_STATUS = 35712),
          (a.DEPTH_ATTACHMENT = 36096),
          (a.DEPTH_BITS = 3414),
          (a.DEPTH_BUFFER_BIT = 256),
          (a.DEPTH_CLEAR_VALUE = 2931),
          (a.DEPTH_COMPONENT = 6402),
          (a.DEPTH_COMPONENT16 = 33189),
          (a.DEPTH_FUNC = 2932),
          (a.DEPTH_RANGE = 2928),
          (a.DEPTH_STENCIL = 34041),
          (a.DEPTH_STENCIL_ATTACHMENT = 33306),
          (a.DEPTH_TEST = 2929),
          (a.DEPTH_WRITEMASK = 2930),
          (a.DITHER = 3024),
          (a.DONT_CARE = 4352),
          (a.DST_ALPHA = 772),
          (a.DST_COLOR = 774),
          (a.DYNAMIC_DRAW = 35048),
          (a.ELEMENT_ARRAY_BUFFER = 34963),
          (a.ELEMENT_ARRAY_BUFFER_BINDING = 34965),
          (a.EQUAL = 514),
          (a.FASTEST = 4353),
          (a.FLOAT = 5126),
          (a.FLOAT_MAT2 = 35674),
          ...
          (a.FLOAT_VEC3 = 35665),
          (a.FLOAT_VEC4 = 35666),
          (a.FRAGMENT_SHADER = 35632),
          (a.FRAMEBUFFER = 36160),
          (a.FRAMEBUFFER_ATTACHMENT_OBJECT_NAME = 36049),
          (a.FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE = 36048),
          (a.FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE = 36051),
          (a.FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL = 36050),
          (a.FRAMEBUFFER_BINDING = 36006),
          (a.FRAMEBUFFER_COMPLETE = 36053),
          (a.FRAMEBUFFER_INCOMPLETE_ATTACHMENT = 36054),
          (a.FRAMEBUFFER_INCOMPLETE_DIMENSIONS = 36057),
          (a.FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT = 36055),
          (a.FRAMEBUFFER_UNSUPPORTED = 36061),
          (a.FRONT = 1028),
          (a.FRONT_AND_BACK = 1032),
          (a.FRONT_FACE = 2886),
          (a.FUNC_ADD = 32774),
          (a.FUNC_REVERSE_SUBTRACT = 32779),
          (a.FUNC_SUBTRACT = 32778),
          (a.GENERATE_MIPMAP_HINT = 33170),
          (a.GEQUAL = 518),
          (a.GREATER = 516),
          (a.GREEN_BITS = 3411),
          (a.HIGH_FLOAT = 36338),
          (a.HIGH_INT = 36341),
          (a.IMPLEMENTATION_COLOR_READ_FORMAT = 35739),
          (a.IMPLEMENTATION_COLOR_READ_TYPE = 35738),
          (a.INCR = 7682),
          (a.INCR_WRAP = 34055),
          (a.INT = 5124),
          (a.INT_VEC2 = 35667),
          ...
          (a.INT_VEC4 = 35669),
          (a.INVALID_ENUM = 1280),
          (a.INVALID_FRAMEBUFFER_OPERATION = 1286),
          (a.INVALID_OPERATION = 1282),
          (a.INVALID_VALUE = 1281),
          (a.INVERT = 5386),
          (a.KEEP = 7680),
          (a.LEQUAL = 515),
          (a.LESS = 513),
          (a.LINEAR = 9729),
          (a.LINEAR_MIPMAP_LINEAR = 9987),
          (a.LINEAR_MIPMAP_NEAREST = 9985),
          (a.LINES = 1),
          (a.LINE_LOOP = 2),
          (a.LINE_STRIP = 3),
          (a.LINE_WIDTH = 2849),
          ...
          (a.LOW_INT = 36339),
          (a.LUMINANCE = 6409),
          (a.LUMINANCE_ALPHA = 6410),
          (a.MAX_COMBINED_TEXTURE_IMAGE_UNITS = 35661),
          (a.MAX_CUBE_MAP_TEXTURE_SIZE = 34076),
          (a.MAX_FRAGMENT_UNIFORM_VECTORS = 36349),
          (a.MAX_RENDERBUFFER_SIZE = 34024),
          (a.MAX_TEXTURE_IMAGE_UNITS = 34930),
          (a.MAX_TEXTURE_SIZE = 3379),
          (a.MAX_VARYING_VECTORS = 36348),
          (a.MAX_VERTEX_ATTRIBS = 34921),
          (a.MAX_VERTEX_TEXTURE_IMAGE_UNITS = 35660),
          (a.MAX_VERTEX_UNIFORM_VECTORS = 36347),
          (a.MAX_VIEWPORT_DIMS = 3386),
          (a.MEDIUM_FLOAT = 36337),
          (a.MEDIUM_INT = 36340),
          (a.MIRRORED_REPEAT = 33648),
          (a.NEAREST = 9728),
          (a.NEAREST_MIPMAP_LINEAR = 9986),
          (a.NEAREST_MIPMAP_NEAREST = 9984),
          (a.NEVER = 512),
          (a.NICEST = 4354),
          (a.NONE = 0),
          (a.NOTEQUAL = 517),
          ...
          (a.OUT_OF_MEMORY = 1285),
          (a.PACK_ALIGNMENT = 3333),
          (a.POINTS = 0),
          (a.POLYGON_OFFSET_FACTOR = 32824),
          (a.POLYGON_OFFSET_FILL = 32823),
          (a.POLYGON_OFFSET_UNITS = 10752),
          (a.RED_BITS = 3410),
          (a.RENDERBUFFER = 36161),
          (a.RENDERBUFFER_ALPHA_SIZE = 36179),
          (a.RENDERBUFFER_BINDING = 36007),
          (a.RENDERBUFFER_BLUE_SIZE = 36178),
          (a.RENDERBUFFER_DEPTH_SIZE = 36180),
          (a.RENDERBUFFER_GREEN_SIZE = 36177),
          (a.RENDERBUFFER_HEIGHT = 36163),
          (a.RENDERBUFFER_INTERNAL_FORMAT = 36164),
          (a.RENDERBUFFER_RED_SIZE = 36176),
          (a.RENDERBUFFER_STENCIL_SIZE = 36181),
          (a.RENDERBUFFER_WIDTH = 36162),
          (a.RENDERER = 7937),
          (a.REPEAT = 10497),
          (a.REPLACE = 7681),
          (a.RGB = 6407),
          ...
          (a.RGBA4 = 32854),
          (a.SAMPLER_2D = 35678),
          (a.SAMPLER_CUBE = 35680),
          (a.SAMPLES = 32937),
          (a.SAMPLE_ALPHA_TO_COVERAGE = 32926),
          (a.SAMPLE_BUFFERS = 32936),
          (a.SAMPLE_COVERAGE = 32928),
          (a.SAMPLE_COVERAGE_INVERT = 32939),
          (a.SAMPLE_COVERAGE_VALUE = 32938),
          (a.SCISSOR_BOX = 3088),
          (a.SCISSOR_TEST = 3089),
          (a.SHADER_TYPE = 35663),
          (a.SHADING_LANGUAGE_VERSION = 35724),
          (a.SHORT = 5122),
          (a.SRC_ALPHA = 770),
          (a.SRC_ALPHA_SATURATE = 776),
          (a.SRC_COLOR = 768),
          (a.STATIC_DRAW = 35044),
          (a.STENCIL_ATTACHMENT = 36128),
          (a.STENCIL_BACK_FAIL = 34817),
          (a.STENCIL_BACK_FUNC = 34816),
          (a.STENCIL_BACK_PASS_DEPTH_FAIL = 34818),
          (a.STENCIL_BACK_PASS_DEPTH_PASS = 34819),
          (a.STENCIL_BACK_REF = 36003),
          (a.STENCIL_BACK_VALUE_MASK = 36004),
          (a.STENCIL_BACK_WRITEMASK = 36005),
          (a.STENCIL_BITS = 3415),
          (a.STENCIL_BUFFER_BIT = 1024),
          (a.STENCIL_CLEAR_VALUE = 2961),
          (a.STENCIL_FAIL = 2964),
          (a.STENCIL_FUNC = 2962),
          (a.STENCIL_INDEX8 = 36168),
          (a.STENCIL_PASS_DEPTH_FAIL = 2965),
          (a.STENCIL_PASS_DEPTH_PASS = 2966),
          (a.STENCIL_REF = 2967),
          (a.STENCIL_TEST = 2960),
          (a.STENCIL_VALUE_MASK = 2963),
          (a.STENCIL_WRITEMASK = 2968),
          (a.STREAM_DRAW = 35040),
          (a.SUBPIXEL_BITS = 3408),
          (a.TEXTURE = 5890),
          (a.TEXTURE0 = 33984),
          (a.TEXTURE1 = 33985),
          (a.TEXTURE2 = 33986),
          ...
          (a.TEXTURE31 = 34015),
          (a.TEXTURE_2D = 3553),
          (a.TEXTURE_BINDING_2D = 32873),
          (a.TEXTURE_BINDING_CUBE_MAP = 34068),
          (a.TEXTURE_CUBE_MAP = 34067),
          (a.TEXTURE_CUBE_MAP_NEGATIVE_X = 34070),
          (a.TEXTURE_CUBE_MAP_NEGATIVE_Y = 34072),
          (a.TEXTURE_CUBE_MAP_NEGATIVE_Z = 34074),
          (a.TEXTURE_CUBE_MAP_POSITIVE_X = 34069),
          (a.TEXTURE_CUBE_MAP_POSITIVE_Y = 34071),
          (a.TEXTURE_CUBE_MAP_POSITIVE_Z = 34073),
          (a.TEXTURE_MAG_FILTER = 10240),
          (a.TEXTURE_MIN_FILTER = 10241),
          (a.TEXTURE_WRAP_S = 10242),
          (a.TEXTURE_WRAP_T = 10243),
          (a.TRIANGLES = 4),
          (a.TRIANGLE_FAN = 6),
          (a.TRIANGLE_STRIP = 5),
          (a.UNPACK_ALIGNMENT = 3317),
          (a.UNPACK_COLORSPACE_CONVERSION_WEBGL = 37443),
          (a.UNPACK_FLIP_Y_WEBGL = 37440),
          (a.UNPACK_PREMULTIPLY_ALPHA_WEBGL = 37441),
          (a.UNSIGNED_BYTE = 5121),
          (a.UNSIGNED_INT = 5125),
          (a.UNSIGNED_SHORT = 5123),
          (a.UNSIGNED_SHORT_4_4_4_4 = 32819),
          (a.UNSIGNED_SHORT_5_5_5_1 = 32820),
          (a.UNSIGNED_SHORT_5_6_5 = 33635),
          (a.VALIDATE_STATUS = 35715),
          (a.VENDOR = 7936),
          (a.VERSION = 7938),
          (a.VERTEX_ATTRIB_ARRAY_BUFFER_BINDING = 34975),
          (a.VERTEX_ATTRIB_ARRAY_ENABLED = 34338),
          (a.VERTEX_ATTRIB_ARRAY_NORMALIZED = 34922),
          (a.VERTEX_ATTRIB_ARRAY_POINTER = 34373),
          (a.VERTEX_ATTRIB_ARRAY_SIZE = 34339),
          (a.VERTEX_ATTRIB_ARRAY_STRIDE = 34340),
          (a.VERTEX_ATTRIB_ARRAY_TYPE = 34341),
          ...
          l = (function () {
            function e(t) {
              ...
              if (
                ...
                a(this, 'protocol', ''),
                a(this, 'readyState', 3),
                'string' != typeof t || !/(^ws:\/\/)|(^wss:\/\/)/.test(t))
              )
                throw new TypeError(
                  "Failed to construct 'WebSocket': The URL '".concat(t, "' is invalid")
                );
              return (
                (this.url = t),
              ...
              (n = [
                {
                  key: 'close',
                  value: function (t, n) {
                    ((this.readyState = e.CLOSING), c.get(this).close({ code: t, reason: n }));
                  }
                },
                {
                  key: 'send',
                  value: function (e) {
                    if (
                      !('string' == typeof e || e instanceof ArrayBuffer || ArrayBuffer.isView(e))
                    )
                      throw new TypeError(
                        'Failed to send message: The data '.concat(e, ' is invalid')
                      );
                    c.get(this).send({ data: e });
                  }
                }
              ]) && i(t.prototype, n),
              Object.defineProperty(t, 'prototype', { writable: !1 }),
    ...
    25: [
      function (t, n, r) {
        ...
        (Object.defineProperty(r, '__esModule', { value: !0 }),
          (r.default = void 0),
          (t = (t = t('./EventTarget.js')) && t.__esModule ? t : { default: t }));
        var d = new WeakMap(),
          p = new WeakMap(),
          m = new WeakMap(),
          h = new WeakMap(),
        ...
        ((t = (function (e) {
          ...
          function r() {
            ...
            if (this instanceof r)
              return (
                s(c((e = n.call(this))), 'timeout', 0),
                s(c(e), 'onabort', null),
                s(c(e), 'onerror', null),
                s(c(e), 'onload', null),
                s(c(e), 'onloadstart', null),
                s(c(e), 'onprogress', null),
                s(c(e), 'ontimeout', null),
                s(c(e), 'onloadend', null),
                s(c(e), 'onreadystatechange', null),
                s(c(e), 'readyState', 0),
                s(c(e), 'response', null),
                s(c(e), 'responseText', null),
                s(c(e), 'responseType', ''),
                s(c(e), 'responseXML', null),
                s(c(e), 'status', 0),
                s(c(e), 'statusText', ''),
                s(c(e), 'upload', {}),
                s(c(e), 'withCredentials', !1),
                m.set(c(e), { 'content-type': 'application/x-www-form-urlencoded' }),
                h.set(c(e), {}),
                e
              );
            throw new TypeError('Cannot call a class as a function');
                    ...
                    success: function (t) {
                      ...
                      switch (
                        ...
                        case 'arraybuffer':
                          ...
                          for (var i = new Uint8Array(n), a = i.byteLength, u = 0; u < a; u++)
                            e.responseText += String.fromCharCode(i[u]);
                          break;
                        default:
                          e.response = null;
                      }
          ...
          s((r.default = t), 'UNSEND', 0),
          s(t, 'OPENED', 1),
          s(t, 'HEADERS_RECEIVED', 2),
          s(t, 'LOADING', 3),
          s(t, 'DONE', 4));
      },
      { './EventTarget.js': 11 }
        ...
        var i = (function (e, t) {
            ...
            for (n in e) {
              ...
              'default' !== n &&
                ...
                ((a = i ? Object.getOwnPropertyDescriptor(e, n) : null) && (a.get || a.set)
    ...
    27: [
      function (t, n, r) {
        ...
        var i = (function (e, t) {
          ...
          a = (a = t('./document')) && a.__esModule ? a : { default: a };
        var u = GameGlobal;
        if (!GameGlobal.__isAdapterInjected)
          if (
            ((GameGlobal.__isAdapterInjected = !0),
            (i.document = a.default),
            ...
            (a = wx.getSystemInfoSync().platform),
            'undefined' == typeof __devtoolssubcontext && 'devtools' === a)
          ) {
            for (var c in i) {
              var l = Object.getOwnPropertyDescriptor(u, c);
              (l && !0 !== l.configurable) || Object.defineProperty(window, c, { value: i[c] });
            }
            for (var s in i.document) {
              var f = Object.getOwnPropertyDescriptor(u.document, s);
              (f && !0 !== f.configurable) ||
                Object.defineProperty(u.document, s, { value: i.document[s] });
            }
        ...
        ((u.CCWebAssembly = u.WebAssembly = u.WXWebAssembly),
          t('../../../../common/xmldom/dom-parser'),
          t('../unify'),
          t('../fs-utils'));
      },
      {
    ...
    29: [
      function (e, t, n) {
        (Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.default = void 0),
          (n.default = { href: 'game.js', protocol: '', reload: function () {} }));
      },
      {}
    ],
    30: [
      function (e, t, n) {
        ...
        var r = wx.getSystemInfoSync(),
          ...
          u =
            ((r = r.version),
            (o =
              -1 !== o.toLowerCase().indexOf('android')
                ? 'Android; CPU '.concat(o)
                : 'iPhone; CPU iPhone OS '.concat(o, ' like Mac OS X')),
            (r = 'Mozilla/5.0 ('
              .concat(
                o,
                ') AppleWebKit/603.1.30 (KHTML, like Gecko) Mobile/14E8301 MicroMessenger/'
              )
              .concat(r, ' MiniGame NetType/WIFI Language/')
              .concat(a)),
            {
              platform: i,
              language: a,
          ...
          i = {
            ...
            deleteFile: function (e, t) {
              r.unlink({
                ...
                fail: function (n) {
                  (console.warn(
                    'Delete file failed: path: '.concat(e, ' message: ').concat(n.errMsg)
                  ),
            ...
            downloadFile: function (e, t, n, r, o) {
              var a = {
                ...
                success: function (t) {
                  200 === t.statusCode
                    ? o && o(null, t.tempFilePath || t.filePath)
                    : (t.filePath && i.deleteFile(t.filePath),
                      console.warn(
                        'Download file failed: path: '.concat(e, ' message: ').concat(t.statusCode)
                      ),
                      o && o(new Error(t.statusCode), null));
                },
                fail: function (t) {
                  (console.warn(
                    'Download file failed: path: '.concat(e, ' message: ').concat(t.errMsg)
                  ),
                    o && o(new Error(t.errMsg), null));
                }
              };
            ...
            saveFile: function (e, t, n) {
              wx.saveFile({
                ...
                fail: function (t) {
                  (console.warn(
                    'Save file failed: path: '.concat(e, ' message: ').concat(t.errMsg)
                  ),
            ...
            copyFile: function (e, t, n) {
              r.copyFile({
                ...
                fail: function (t) {
                  (console.warn(
                    'Copy file failed: path: '.concat(e, ' message: ').concat(t.errMsg)
                  ),
                    n && n(new Error(t.errMsg)));
                }
              });
            ...
            writeFile: function (e, t, n, o) {
              r.writeFile({
                ...
                fail: function (t) {
                  (console.warn(
                    'Write file failed: path: '.concat(e, ' message: ').concat(t.errMsg)
                  ),
                    o && o(new Error(t.errMsg)));
                }
              });
            },
            writeFileSync: function (e, t, n) {
              try {
                ...
                return (
                  console.warn(
                    'Write file failed: path: '.concat(e, ' message: ').concat(t.message)
                  ),
                  new Error(t.message)
                );
              }
            ...
            readFile: function (e, t, n) {
              r.readFile({
                ...
                fail: function (t) {
                  (console.warn(
                    'Read file failed: path: '.concat(e, ' message: ').concat(t.errMsg)
                  ),
            ...
            readDir: function (e, t) {
              r.readdir({
                ...
                fail: function (n) {
                  (console.warn(
                    'Read directory failed: path: '.concat(e, ' message: ').concat(n.errMsg)
                  ),
              ...
              i.readFile(e, 'utf8', function (n, r) {
                ...
                if (!n)
                  try {
                    ...
                    (console.warn(
                      'Read json failed: path: '.concat(e, ' message: ').concat(r.message)
                    ),
            ...
            readJsonSync: function (e) {
              try {
                ...
                return (
                  console.warn(
                    'Read json failed: path: '.concat(e, ' message: ').concat(t.message)
                  ),
                  new Error(t.message)
                );
              }
            ...
            makeDirSync: function (e, t) {
              try {
                ...
                return (
                  console.warn(
                    'Make directory failed: path: '.concat(e, ' message: ').concat(t.message)
                  ),
                  new Error(t.message)
                );
              }
            ...
            rmdirSync: function (e, t) {
              try {
                ...
                return (
                  console.warn(
                    'rm directory failed: path: '.concat(e, ' message: ').concat(t.message)
                  ),
                  new Error(t.message)
                );
              }
            ...
            loadSubpackage: function (e, t, n) {
              var r = wx.loadSubpackage({
                ...
                fail: function (t) {
                  (console.warn(
                    'Load Subpackage failed: path: '.concat(e, ' message: ').concat(t.errMsg)
                  ),
                    n &&
                      n(new Error('Failed to load subpackage '.concat(e, ': ').concat(t.errMsg))));
                }
              });
            ...
            unzip: function (e, t, n) {
              r.unzip({
                ...
                fail: function (t) {
                  (console.warn('unzip failed: path: '.concat(e, ' message: ').concat(t.errMsg)),
                    n && n(new Error('unzip failed: '.concat(t.errMsg))));
                }
              });
            }
          };
      ...
      function (e, t, n) {
        ...
        ((window.__globalAdapter = window.__globalAdapter || {}),
          window.__globalAdapter &&
            ((r = window.__globalAdapter),
            (i = (o = wx.getSystemInfoSync()).windowWidth),
            (a = o.windowHeight < i),
            (r.isSubContext = void 0 === wx.getOpenDataContext),
            (r.isDevTool = 'devtools' === o.platform),
            e.cloneMethod(r, wx, 'getSystemInfoSync'),
            e.cloneMethod(r, wx, 'onTouchStart'),
            e.cloneMethod(r, wx, 'onTouchMove'),
            e.cloneMethod(r, wx, 'onTouchEnd'),
            e.cloneMethod(r, wx, 'onTouchCancel'),
            e.cloneMethod(r, wx, 'createInnerAudioContext'),
            e.cloneMethod(r, wx, 'onAudioInterruptionEnd'),
            e.cloneMethod(r, wx, 'onAudioInterruptionBegin'),
            e.cloneMethod(r, wx, 'createVideo'),
            e.cloneMethod(r, wx, 'setPreferredFramesPerSecond'),
            e.cloneMethod(r, wx, 'showKeyboard'),
            e.cloneMethod(r, wx, 'hideKeyboard'),
            e.cloneMethod(r, wx, 'updateKeyboard'),
            e.cloneMethod(r, wx, 'onKeyboardInput'),
            e.cloneMethod(r, wx, 'onKeyboardConfirm'),
            e.cloneMethod(r, wx, 'onKeyboardComplete'),
            e.cloneMethod(r, wx, 'offKeyboardInput'),
            e.cloneMethod(r, wx, 'offKeyboardConfirm'),
            e.cloneMethod(r, wx, 'offKeyboardComplete'),
            e.cloneMethod(r, wx, 'getOpenDataContext'),
            e.cloneMethod(r, wx, 'onMessage'),
            e.cloneMethod(r, wx, 'loadSubpackage'),
            e.cloneMethod(r, wx, 'getSharedCanvas'),
            e.cloneMethod(r, wx, 'loadFont'),
            e.cloneMethod(r, wx, 'onShow'),
            e.cloneMethod(r, wx, 'onHide'),
            'function' == typeof getApp && ((wx.onShow = wx.onAppShow), (wx.onHide = wx.onAppHide)),
            e.cloneMethod(r, wx, 'onError'),
            e.cloneMethod(r, wx, 'offError'),
            (u = !1),
            (c = 1),
