 ...
 * define("cocos-js/spine.wasm-CKrzExoH.js") body.
 */

'use strict';
require('../@babel/runtime/helpers/Arrayincludes');
var n = require('../@babel/runtime/helpers/typeof');
System.register(['./_virtual_cc-cf1p7Jgo.js'], function (t) {
  var e;
  return {
    setters: [
      function (n) {
    ...
    execute: function () {
      ...
      t(
        ...
        function (t) {
          ...
          function F() {
            var n = l.buffer;
            ((i.HEAP8 = h = new Int8Array(n)),
              (i.HEAP16 = d = new Int16Array(n)),
              (i.HEAP32 = y = new Int32Array(n)),
              (i.HEAPU8 = p = new Uint8Array(n)),
              (i.HEAPU16 = v = new Uint16Array(n)),
              (i.HEAPU32 = m = new Uint32Array(n)),
              (i.HEAPF32 = g = new Float32Array(n)),
              (i.HEAPF64 = b = new Float64Array(n)));
          }
          var T,
            C = [],
            A = [],
          ...
          if (!S((k = 'spine.wasm'))) {
            var G = k;
            k = i.locateFile ? i.locateFile(G, s) : s + G;
          }
          function R(n) {
            try {
              if (n == k && c) return new Uint8Array(c);
          ...
          function j(n, t, e) {
            return (function (n) {
              return c || 'function' != typeof fetch
          ...
          function Y(n, t) {
            ...
            var e = t.name;
            if (
              (n || B('type "' + e + '" must have a positive integer typeid pointer'),
              x.hasOwnProperty(n))
            ) {
              if ({}.qa) return;
              B("Cannot register type '" + e + "' twice");
            }
            ((x[n] = t),
              delete K[n],
              J.hasOwnProperty(n) &&
          ...
          function $(n) {
            B(n.F.I.G.name + ' instance already deleted');
          }
          var Q = !1;
          function nn() {}
          function tn(n) {
          ...
          function sn(n, t) {
            return (
              (t.I && t.H) || Z('makeClassHandle requires ptr and ptrType'),
              !!t.M != !!t.L && Z('Both smartPtrType and smartPtr must be specified'),
              (t.count = { value: 1 }),
              cn(Object.create(n, { F: { value: t } }))
            );
          }
          function cn(n) {
            return 'undefined' == typeof FinalizationRegistry
              ? ((cn = function (n) {
                ...
                n)
              : ((Q = new FinalizationRegistry(function (n) {
                  tn(n.F);
                })),
                (nn = function (n) {
                  Q.unregister(n);
                ...
                (cn = function (n) {
                  var t = n.F;
                  return (t.L && Q.register(n, { F: t }, n), n);
                })(n));
          }
          function fn() {}
          function ln(n, t, e) {
            if (void 0 === n[t].K) {
              ...
              ((n[t] = function () {
                return (
                  n[t].K.hasOwnProperty(arguments.length) ||
                    B(
                      "Function '" +
                        e +
                  ...
                  n[t].K[arguments.length].apply(this, arguments)
                );
              }),
                (n[t].K = []),
                (n[t].K[r.T] = r));
          ...
          function hn(n, t) {
            i.hasOwnProperty(n)
              ? (B("Cannot register public name '" + n + "' twice"),
                ln(i, n, n),
                i.hasOwnProperty(void 0) &&
                  B(
          ...
          function dn(n, t, e) {
            for (; t !== e; )
              (t.W ||
                B('Expected null or instance of ' + e.name + ', got an instance of ' + t.name),
                (n = t.W(n)),
                (t = t.J));
            return n;
          }
          function vn(n, t) {
            return null === t
              ? (this.$ && B('null is not a valid ' + this.name), 0)
              : (t.F || B('Cannot pass "' + Rn(t) + '" as a ' + this.name),
                t.F.H || B('Cannot pass deleted object as a pointer of type ' + this.name),
                dn(t.F.H, t.F.I.G, this.G));
          }
          function yn(n, t) {
            if (null === t) {
              if ((this.$ && B('null is not a valid ' + this.name), this.Z)) {
                var e = this.ma();
              ...
              !this.Y &&
                ...
                B(
                  'Cannot convert argument of type ' +
                    (t.F.M ? t.F.M.name : t.F.I.name) +
                    ' to parameter type ' +
                    this.name
                ),
              (e = dn(t.F.H, t.F.I.G, this.G)),
              this.Z)
            )
              switch (
                (void 0 === t.F.L && B('Passing raw pointer to smart pointer is illegal'), this.pa)
              ) {
                case 0:
                  t.F.M === this
                    ? (e = t.F.L)
          ...
          function bn(n, t, e, r) {
            ((this.name = n),
              ...
              void 0 !== t.J
                ? (this.toWireType = yn)
                : ((this.toWireType = r ? vn : mn), (this.O = null)));
          }
          function wn(n, t) {
            (i.hasOwnProperty(n) || Z('Replacing nonexistant public symbol'),
              (i[n] = t),
              (i[n].T = void 0));
          }
          function Fn(n, t) {
            var e = (n = M(n)).includes('j')
              ? (function (n, t) {
                  var e = [];
                  return function () {
            ...
            return (
              'function' != typeof e &&
                B('unknown function pointer with signature ' + n + ': ' + t),
              e
            );
          }
          var Tn = void 0;
          ...
          function Wn(n, t, e, r, i) {
            var o = t.length;
            2 > o &&
              B("argTypes array size mismatch! Must at least get return value and 'this' types!");
            ...
            return function () {
              ...
              for (var o = 0; o < c; ++o)
                ((f[o] = t[o + 2].toWireType(h, arguments[o])), l.push(f[o]));
              if (((o = r.apply(null, l)), u)) Pn(h);
              else
          ...
          function On(n, t, e) {
            return (
              n instanceof Object || B(e + ' with invalid "this": ' + n),
              n instanceof t.G.constructor ||
                B(e + ' incompatible with "this" of type ' + n.constructor.name),
              n.F.H || B('cannot call emscripten binding method ' + e + ' on deleted object'),
              dn(n.F.H, n.F.I.G, t.G)
            );
          }
          var In = new (function () {
            ((this.N = [void 0]),
          ...
          var Sn = function (n) {
              return (n || B('Cannot use deleted val. handle = ' + n), In.get(n).value);
            },
            Gn = function (n) {
              switch (n) {
                case void 0:
          ...
          function _n(n, t) {
            var e = x[n];
            return (void 0 === e && B(t + ' has unknown type ' + Cn(n)), e);
          }
          var Mn = {},
            Jn = [];
          function xn() {
            ...
            ((n = n.getCurrentEventType()),
              globalThis.TrackEntryListeners.emitListener(t, e, r, n));
          }
          function Kn() {
            var n = i.SpineWasmUtil,
              t = n.getCurrentListenerID(),
            ...
            ((n = n.getCurrentEvent()),
              globalThis.TrackEntryListeners.emitTrackEntryListener(t, r, n, e));
          }
          ((i._spineListenerCallBackFromJS = xn), (i._spineTrackListenerCallback = Kn));
          for (var Nn = Array(256), Vn = 0; 256 > Vn; ++Vn) Nn[Vn] = String.fromCharCode(Vn);
          ((_ = Nn),
            (z = i.BindingError = D('BindingError')),
            (q = i.InternalError = D('InternalError')),
            (fn.prototype.isAliasOf = function (n) {
            ...
            (fn.prototype.clone = function () {
              ...
              return (
                ((n = n(
                  e.call(t, r, {
                    F: { value: { count: i.count, U: i.U, V: i.V, H: i.H, I: i.I, L: i.L, M: i.M } }
                  })
                )).F.count.value += 1),
                (n.F.U = !1),
                n
            ...
            (fn.prototype.delete = function () {
              (this.F.H || $(this),
                this.F.U && !this.F.V && B('Object already scheduled for deletion'),
                nn(this),
                tn(this.F),
            ...
            (bn.prototype.readValueFromPointer = gn),
            (bn.prototype.deleteObject = function (n) {
              null !== n && n.delete();
            }),
            (bn.prototype.fromWireType = function (n) {
              function t() {
                return this.Z
                  ? sn(this.G.P, { I: this.ka, H: e, M: this, L: n })
                  : sn(this.G.P, { I: this, H: n });
              }
              var e = this.ja(n);
              if (!e) return (this.ca(n), null);
              var r = (function (n, t) {
                for (void 0 === t && B('ptr should not be undefined'); n.J; )
                  ((t = n.W(t)), (n = n.J));
                return un[t];
              })(this.G, e);
              if (void 0 !== r)
                return 0 === r.F.count.value
                  ? ((r.F.H = e), (r.F.L = n), r.clone())
                  : ((r = r.clone()), this.ca(n), r);
              ...
              return null === i
                ? t.call(this)
                : this.Z
                  ? sn(r.G.P, { I: r, H: i, M: this, L: n })
                  : sn(r.G.P, { I: r, H: i });
            }),
            (Tn = i.UnboundTypeError = D('UnboundTypeError')),
            In.N.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }),
            (In.ba = In.N.length),
          ...
          var Dn,
            zn = {
              ...
              c: function (n, t, e, r, i, o, a, u, s, c, f, l, h) {
                ...
                var p = N(f);
                (hn(p, function () {
                  An('Cannot construct ' + f + ' due to unbound types', [r]);
                }),
                  X([n, t, e], r ? [r] : [], function (t) {
                    ...
                    t = V(p, function () {
                      if (Object.getPrototypeOf(this) !== a)
                        throw new z("Use 'new' to construct " + f);
                      if (void 0 === s.R) throw new z(f + ' has no accessible constructor');
                    ...
                    (s.J && (void 0 === s.J.X && (s.J.X = []), s.J.X.push(s)),
                      (e = new bn(f, s, !0, !1)),
                      (i = new bn(f + '*', s, !1, !1)));
                    var l = new bn(f + ' const*', s, !1, !0);
                    return ((en[n] = { pointerType: i, ga: l }), wn(p, t), [e, i, l]);
                  }));
              },
              g: function (n, t, r, i, o, a, u) {
                ...
                ((t = M(t)),
                  ...
                  X([], [n], function (n) {
                    function i() {
                      An('Cannot call ' + o + ' due to unbound types', s);
                    }
                    var o = (n = n[0]).name + '.' + t;
                    ...
                    return (
                      void 0 === c[t]
                        ? ((i.T = r - 1), (c[t] = i))
                        : (ln(c, t, o), (c[t].K[r - 1] = i)),
                      X([], s, function (i) {
                        if (
                          ((i = Wn(o, [i[0], null].concat(i.slice(1)), null, a, u)),
                          void 0 === c[t].K ? ((i.T = r - 1), (c[t] = i)) : (c[t].K[r - 1] = i),
                          n.G.X)
                        )
                ...
                ((t = M(t)),
                  ...
                  X([], [n], function (n) {
                    var i = (n = n[0]).name + '.' + t,
                      s = {
                        get: function () {
                          An('Cannot access ' + i + ' due to unbound types', [e]);
                        },
                        enumerable: !0,
                        configurable: !0
                      };
                    return (
                      (s.set = u
                        ...
                        : function () {
                            B(i + ' is a read-only property');
                          }),
                      Object.defineProperty(n.G.constructor, t, s),
                      X([], [e], function (e) {
                        e = e[0];
                        var i = {
                          get: function () {
              ...
              d: function (n, t, e, r, i, o) {
                ...
                ((i = Fn(r, i)),
                  X([], [n], function (n) {
                    ...
                    if ((void 0 === n.G.R && (n.G.R = []), void 0 !== n.G.R[t - 1]))
                      throw new z(
                    ...
                    return (
                      (n.G.R[t - 1] = function () {
                        An('Cannot construct ' + n.name + ' due to unbound types', a);
                      }),
                      X([], a, function (r) {
                        return (r.splice(1, 0, null), (n.G.R[t - 1] = Wn(e, r, null, i, o)), []);
                      }),
                      []
                    );
                  }));
              ...
              a: function (n, t, e, r, i, o, a, u) {
                ...
                ((t = M(t)),
                  ...
                  X([], [n], function (n) {
                    function r() {
                      An('Cannot call ' + i + ' due to unbound types', s);
                    }
                    var i = (n = n[0]).name + '.' + t;
                    ...
                    var c = n.G.P,
                      f = c[t];
                    return (
                      void 0 === f || (void 0 === f.K && f.className !== n.name && f.T === e - 2)
                        ? ((r.T = e - 2), (r.className = n.name), (c[t] = r))
                        : (ln(c, t, i), (c[t].K[e - 2] = r)),
                      X([], s, function (r) {
                        return (
                          (r = Wn(i, r, n, o, a)),
                          void 0 === c[t].K ? ((r.T = e - 2), (c[t] = r)) : (c[t].K[e - 2] = r),
                          []
                        );
                      }),
                      []
                ...
                ((t = M(t)),
                  ...
                  X([], [n], function (n) {
                    var r = (n = n[0]).name + '.' + t,
                      f = {
                        get: function () {
                          An('Cannot access ' + r + ' due to unbound types', [e, a]);
                        },
                        enumerable: !0,
                        configurable: !0
                      };
                    return (
                      (f.set = s
                        ...
                        : function () {
                            B(r + ' is a read-only property');
                          }),
                      Object.defineProperty(n.G.P, t, f),
                      X([], s ? [e, a] : [e], function (e) {
                        var a = e[0],
                          f = {
                            get: function () {
              ...
              x: function (n, t) {
                ...
                Y(n, {
                  ...
                  toWireType: function (n, t) {
                    ...
                    if (((a = (i = Bn(4 + (r = i) + 1)) + 4), (m[i >> 2] = r), e && o)) {
                      if (((o = a), (a = r + 1), (r = p), 0 < a)) {
                        ...
                        for (var u = 0; u < t.length; ++u) {
                          ...
                          if (
                            (55296 <= s &&
                              57343 >= s &&
                              (s = (65536 + ((1023 & s) << 10)) | (1023 & t.charCodeAt(++u))),
                            127 >= s)
                          ) {
                            if (o >= a) break;
                            r[o++] = s;
                      ...
                      for (o = 0; o < r; ++o)
                        (255 < (u = t.charCodeAt(o)) &&
                          (qn(a), B('String has UTF-16 code units that do not fit in 8 bits')),
                          (p[a + o] = u));
                    else for (o = 0; o < r; ++o) p[a + o] = t[o];
              ...
              m: function (n, t, e) {
                var r;
                for (Jn.length = 0, e >>= 2; (r = p[t++]); )
                  ((e += (105 != r) & e), Jn.push(105 == r ? y[e] : b[e++ >> 1]), ++e);
          ...
          function Bn() {
            return (Bn = i.asm.B).apply(null, arguments);
          }
          function qn() {
          ...
          function Xn() {
            function n() {
              if (!Dn && ((Dn = !0), (i.calledRun = !0), !w)) {
                if ((U(A), o(i), i.onRuntimeInitialized && i.onRuntimeInitialized(), i.postRun))
                  for (
            ...
            ((function () {
              function n(n) {
                if (
                  ...
                  A.unshift(i.asm.z),
                  O--,
                  i.monitorRunDependencies && i.monitorRunDependencies(O),
                  0 == O && I)
                ) {
                  var t = I;
                  ((I = null), t());
              ...
              var t = { a: zn };
              if ((O++, i.monitorRunDependencies && i.monitorRunDependencies(O), i.instantiateWasm))
                try {
              ...
              (function (n, t) {
                ...
                return c ||
                  ...
                  ? j(e, n, t)
                  : fetch(e, { credentials: 'same-origin' }).then(function (r) {
