...
!(function e(t, n, i) {
...
})(
  {
    1: [
      function (e, t, n) {
        var i = e('./cache-manager'),
          ...
          _ =
            ((f.maxConcurrency = 12),
            (f.maxRequestsPerFrame = 64),
            (m.scene.maxConcurrency = 12),
            (m.scene.maxRequestsPerFrame = 64),
            {}),
          v = cc.sys;
        function y(t, n, i) {
          h.test(t)
            ? i && i(new Error('Can not load remote scripts'))
            : (v.platform !== v.Platform.TAOBAO_CREATIVE_APP && e('../../../'.concat(t)),
              i && i(null));
        }
        function g(e, t, n) {
          cc.AudioPlayer.load(e)
            .then(function (t) {
              ((t = { player: t, url: e, duration: t.duration, type: t.type }), n(null, t));
            })
            .catch(function (e) {
              n(e);
            });
        ...
        function b(e, t, n, o, r) {
          var c = (function (e, t) {
            var n = !1,
              o = !1;
            return (
              !e.startsWith(u()) && h.test(e)
                ? t.reload ||
                  ((t = i.cachedFiles.get(e))
                    ? ((o = !0), (e = t.url))
                    : (t = i.tempFiles.get(e)) && ((n = !0), (e = t)))
                : (n = !0),
              { url: e, inLocal: n, inCache: o }
            );
          })(e, n);
          c.inLocal
            ? t(c.url, n, r)
              ...
              : a(e, null, n.header, o, function (o, a) {
                  o
                    ...
                    : t(a, n, function (t, o) {
                        (t ||
                          (i.tempFiles.add(e, a),
                          i.cacheFile(e, a, n.cacheEnabled, n.__cacheBundleRoot__, !0)),
                          r(t, o));
                      });
                });
        }
        ...
        var I = p.parsePVRTex,
          ...
          K = p.parsePlist;
        ((f.downloadScript = y),
          (f._downloadArrayBuffer = function (e, t, n) {
          ...
          f.register({
            ...
            bundle: function (t, n, r) {
              var c,
                s,
                d,
                p = cc.path.basename(t),
                m = (m = n.version || cc.assetManager.downloader.bundleVers[p])
                  ? ''.concat(m, '.')
                  : '';
              _[p]
                ? ((c = (v.platform === v.Platform.TAOBAO_MINI_GAME ? '' : 'subpackages/')
                    .concat(p, '/config.')
                    .concat(m, 'json')),
                  l(p, n.onFileProgress, function (e) {
                    e
                      ? r(e, null)
                      : x(c, n, function (e, t) {
                          var n;
                          ((n = t) &&
                            (v.platform === v.Platform.TAOBAO_MINI_GAME
                              ? (n.base = ''.concat(p, '/'))
                              : (n.base = 'subpackages/'.concat(p, '/'))),
                            r(e, t));
                        });
                  }))
                : (h.test(t) || t.startsWith(u())
                    ? ((d = t),
                      (s = 'src/bundle-scripts/'.concat(p, '/index.').concat(m, 'js')),
                      i.makeBundleFolder(p))
                    : -1 !== f.remoteBundles.indexOf(p)
                      ? ((d = ''.concat(f.remoteServerAddress, 'remote/').concat(p)),
                        (s = 'src/bundle-scripts/'.concat(p, '/index.').concat(m, 'js')),
                        i.makeBundleFolder(p))
                      : ((d = 'assets/'.concat(p)),
                        (s = 'assets/'.concat(p, '/index.').concat(m, 'js'))),
                  v.platform === v.Platform.TAOBAO_MINI_GAME
                    ? e(s)
                    : v.platform !== v.Platform.TAOBAO_CREATIVE_APP && e('./'.concat(s)),
                  (n.__cacheBundleRoot__ = p),
                  x(''.concat(d, '/config.').concat(m, 'json'), n, function (e, t) {
                    var c, s, l;
                    e
                      ? r && r(e)
                      : t.isZip
                        ? ((e = t.zipVersion),
                          (e = ''.concat(d, '/res.').concat(e ? ''.concat(e, '.') : '', 'zip')),
                          (c = e),
                          (s = n),
                          (l = function (e, n) {
                            e
                              ? r && r(e)
                              : ((t.base = ''.concat(n, '/res/')),
                                v.platform === v.Platform.ALIPAY_MINI_GAME &&
                                  v.os === v.OS.ANDROID &&
                                  ((e = ''.concat(n, 'res/')), o.accessSync({ path: e }).success) &&
                                  (t.base = e),
                                r && r(null, t));
                          }),
                          (e = i.cachedFiles.get(c))
                            ? (i.updateLastTime(c), l && l(null, e.url))
                            : h.test(c)
                              ? a(c, null, s.header, s.onFileProgress, function (e, t) {
                                  e
                                    ? l && l(e)
                                    : i.unzipAndCacheBundle(c, t, s.__cacheBundleRoot__, l);
                                })
                              : i.unzipAndCacheBundle(c, c, s.__cacheBundleRoot__, l))
                        : ((t.base = ''.concat(d, '/')), r && r(null, t));
                  }));
            },
          ...
          cc.assetManager.transformPipeline.append(function (e) {
            for (var t = (e.output = e.input), n = 0, i = t.length; n < i; n++) {
              ...
              '.cconb' === o.ext
                ? (o.url = o.url.replace(o.ext, '.bin'))
                : '.ccon' === o.ext && (o.url = o.url.replace(o.ext, '.json'));
            }
          }));
        var B = cc.assetManager.init;
        cc.assetManager.init = function (e) {
          (B.call(cc.assetManager, e),
    ...
    2: [
      function (e, t, n) {
        ...
        cc &&
          cc.internal &&
          cc.internal.EditBox &&
          ((o = cc.internal.EditBox),
          (a = cc.js),
          (r = o.KeyboardReturnType),
          (s = c = null),
          a.extend(i, o._EditBoxImpl),
          (o._EditBoxImpl = i),
            ...
            beginEditing: function () {
              ...
              this._editing ||
                this._ensureKeyboardHide(function () {
                  var t = e._delegate;
                  (e._showKeyboard(),
                    e._registerKeyboardEvent(),
                    (e._editing = !0),
                    (s = e),
                    t._editBoxEditingDidBegan());
                });
            },
            endEditing: function () {
              this._hideKeyboard();
            ...
            _registerKeyboardEvent: function () {
              ...
              ((n.onKeyboardInput = function (e) {
                ...
                (n.onKeyboardComplete = function (n) {
                  ((e._editing = !1),
                    (s = null),
                    cc.sys.platform !== cc.sys.Platform.WECHAT_MINI_PROGRAM &&
                      e._unregisterKeyboardEvent(),
                    n && n.value && n.value !== t.string && t._editBoxTextChanged(n.value),
                    n && n.value
                      ? t._editBoxEditingDidEnded(n.value)
                      : t._editBoxEditingDidEnded());
                }),
                __globalAdapter.onKeyboardInput(n.onKeyboardInput),
                __globalAdapter.onKeyboardConfirm(n.onKeyboardConfirm),
                __globalAdapter.onKeyboardComplete(n.onKeyboardComplete));
            },
            _unregisterKeyboardEvent: function () {
              var e = this._eventListeners;
              (e.onKeyboardInput &&
                (__globalAdapter.offKeyboardInput(e.onKeyboardInput), (e.onKeyboardInput = null)),
                e.onKeyboardConfirm &&
                  (__globalAdapter.offKeyboardConfirm(e.onKeyboardConfirm),
                  (e.onKeyboardConfirm = null)),
                e.onKeyboardComplete &&
                  (__globalAdapter.offKeyboardComplete(e.onKeyboardComplete),
        ...
        cc.assetManager.cacheManager = t.exports = {
          ...
          init: function () {
            ...
            var e = ''.concat(this.cacheDir, '/').concat(this.cachedFileName),
              t = a(e);
            (t instanceof Error || !t.version
              ? (t instanceof Error || d(this.cacheDir, !0),
                (this.cachedFiles = new cc.AssetManager.Cache()),
                r(this.cacheDir, !0),
                c(
                  e,
                  JSON.stringify({ files: this.cachedFiles._map, version: this.version }),
                  'utf8'
                ))
              : (this.cachedFiles = new cc.AssetManager.Cache(t.files)),
          ...
          _write: function () {
            ((m = null),
              c(
                ''.concat(this.cacheDir, '/').concat(this.cachedFileName),
                JSON.stringify({ files: this.cachedFiles._map, version: this.version }),
                'utf8'
              ));
          },
          ...
          _cache: function () {
            ...
            function d(e) {
              if (e) {
                if (f(e.message))
                  return ((c.outOfStorage = !0), void (c.autoClear && c.clearLRU()));
              } else (c.cachedFiles.add(u, { bundle: o, url: r, lastTime: a }), c.writeCacheFile());
              (delete c.cacheQueue[u],
                cc.js.isEmptyObject(c.cacheQueue) ||
                  p ||
                  ((p = !0), setTimeout(c._cache.bind(c), c.cacheInterval)));
            }
            u &&
              ((n = (t = this.cacheQueue[u]).srcUrl),
              (i = t.isCopy),
              (o = t.cacheBundleRoot),
              (a = Date.now().toString()),
              (r = ''),
              (r = (
                o ? ''.concat(this.cacheDir, '/').concat(o, '/') : ''.concat(this.cacheDir, '/')
              )
                .concat(a)
                .concat(v++)
                .concat(cc.path.extname(u))),
              i ? s(n, r, d) : l(n, r, null, d));
          },
          cacheFile: function (e, t, n, i, o) {
            !(n = void 0 !== n ? n : this.cacheEnabled) ||
              this.cacheQueue[e] ||
              this.cachedFiles.has(e) ||
              ((this.cacheQueue[e] = { srcUrl: t, cacheBundleRoot: i, isCopy: o }), p) ||
              this.outOfStorage ||
              ((p = !0), setTimeout(this._cache.bind(this), this.cacheInterval));
          },
          clearCache: function () {
            var e = this;
            (d(this.cacheDir, !0),
              ...
              clearTimeout(m),
              this._write(),
              cc.assetManager.bundles.forEach(function (t) {
            ...
            if (!_) {
              ...
              (this.cachedFiles.forEach(function (n, i) {
                (t._isZipFile(i) &&
                  ...
                  e.push({ originUrl: i, url: n.url, lastTime: n.lastTime });
              }),
                e.sort(function (e, t) {
                ...
                e.length < 3
                  ...
                  : (e.length = Math.floor(e.length / 3)));
              ...
              (clearTimeout(m),
                ...
                setTimeout(function n() {
                  var i = e.pop();
                  (t._removePathOrFile(i.originUrl, i.url),
                    0 < e.length ? setTimeout(n, t.deleteInterval) : (_ = !1));
                }, t.deleteInterval));
            }
          },
          removeCache: function (e) {
            var t;
            this.cachedFiles.has(e) &&
              ((t = this.cachedFiles.remove(e).url),
              clearTimeout(m),
              this._write(),
              this._removePathOrFile(e, t));
          },
          _removePathOrFile: function (e, t) {
            !this._isZipFile(e) || this._isZipFile(t)
              ? u(t, this._deleteFileCB.bind(this))
              : (d(t, !0), this._deleteFileCB());
          },
          ...
          unzipAndCacheBundle: function (e, t, n, i) {
            ...
            (r(a, !0),
              h(t, a, function (t) {
                t
                  ? (d(a, !0),
                    f(t.message) && ((c.outOfStorage = !0), c.autoClear) && c.clearLRU(),
                    i && i(t))
                  : (c.cachedFiles.add(e, { bundle: n, url: a, lastTime: o }),
                    c.writeCacheFile(),
                    i && i(null, a));
              }));
          },
    ...
    5: [
      function (t, n, i) {
        ...
        function c(e) {
          ...
          return function () {
            var n,
              i = s(e);
            ((n = t
              ? ((n = s(this).constructor), Reflect.construct(i, arguments, n))
        ...
        cc.internal.VideoPlayer &&
          ((l = cc.internal.VideoPlayer.EventType),
          (u = cc.mat4()),
          (d = new cc.Vec3()),
          (h = new cc.Vec3()),
          (f = wx.getSystemInfoSync().pixelRatio),
            ...
            return (
              ...
              (e = [
                ...
                },
                {
                  ...
                  value: function () {
                    this._loaded ||
                      ...
                      this.dispatchEvent(l.READY_TO_PLAY),
                      this.delayedPlay());
                  }
                },
                {
                  ...
                  value: function () {
                    ...
                    e &&
                      ...
                      e.onEnded(function () {
                        t._video === e &&
                          ((t._playing = !1),
                          (t._currentTime = t._duration),
                          t.dispatchEvent(l.COMPLETED));
                      }),
                      e.onPause(function () {
                ...
                },
                {
                  ...
                  value: function (e) {
                    __globalAdapter.createVideo
                      ? (this._video ||
                          ((this._video = __globalAdapter.createVideo()),
                          (this._video.showCenterPlayBtn = !1),
                    ...
                    n &&
                      ...
                      n.onPlay(function () {
                        (n.offPlay(),
                          ...
                          (t._playing = !1),
                          (t._currentTime = 0),
                          t.dispatchEvent(l.READY_TO_PLAY),
                          (n.autoplay = !1));
                      }));
                  }
                },
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    t &&
                      this._visible !== e &&
                      ((t.width = (e && this._actualWidth) || 0), (this._visible = e));
                  }
                },
                {
                  key: 'getDuration',
                ...
                },
                {
                  ...
                  value: function (e) {
                    this._video &&
                      (e || this._video.pause(), this.setVisible(!1), (this._visible = !1));
                  }
                },
                {
                  key: 'enable',
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    t &&
                      ...
                      t.stop().then(function (t) {
                        t.errMsg && !t.errMsg.includes('ok')
                          ? console.error('failed to stop video player')
                          : ((e._currentTime = 0), (e._playing = !1), e.dispatchEvent(l.STOPPED));
                      }));
                  }
                },
                {
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    t &&
                      ...
                      (e ? t.requestFullScreen() : t.exitFullScreen(),
                      (this._fullScreenEnabled = e));
                  }
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this._video &&
                      ...
                      (e = (t = this._uiTrans.contentSize).width),
                      (t = t.height),
                      (!this._forceUpdate &&
                        this._m00 === u.m00 &&
                        this._m01 === u.m01 &&
                        ...
                        (t = this._uiTrans.anchorPoint),
                        cc.Vec3.set(d, -t.x * this._w, (1 - t.y) * this._h, 0),
                        cc.Vec3.set(h, (1 - t.x) * this._w, -t.y * this._h, 0),
                        cc.Vec3.transformMat4(d, d, u),
                        cc.Vec3.transformMat4(h, h, u),
                        n.worldToScreen(d, d),
                        n.worldToScreen(h, h),
                        (t = h.x - d.x),
                        (n = d.y - h.y),
                        (this._video.x = d.x / f),
                        (this._video.y = (e - d.y) / f),
                        (this._actualWidth = this._video.width = t / f),
                        (this._video.height = n / f),
                        (this._forceUpdate = !1)));
                  }
                }
              ]) && a(t.prototype, e),
    ...
    6: [
      ...
      { '../../../../common/engine/index': 4, './VideoPlayer': 5, './sprite-frame': 7 }
    ],
    7: [
      function (e, t, n) {
        cc.SpriteFrame &&
          (cc.SpriteFrame.prototype._checkPackable = function () {
            ...
            i &&
              (!((e = this._texture) instanceof cc.Texture2D) ||
              e.isCompressed ||
              ((t = this.width), (n = this.height), !e.image) ||
              t > i.maxFrameSize ||
              n > i.maxFrameSize
                ? (this._packable = !1)
                : e.image && e.image.getContext && (this._packable = !0));
          });
      },
      {}
    ]
