 ...
 * define("src/system.bundle.f45da.js") body.
 */
...
!(function () {
  ...
  if (!n && 'undefined' != typeof location) {
    var l = (n = location.href.split('#')[0].split('?')[0]).lastIndexOf('/');
    -1 !== l && (n = n.slice(0, l + 1));
  }
  ...
  var f = /\\/g;
  function a(e, t) {
    if ((-1 !== e.indexOf('\\') && (e = e.replace(f, '/')), '/' === e[0] && '/' === e[1]))
    ...
    if (
      ...
      for (var i = n.slice(0, n.lastIndexOf('/') + 1) + e, o = [], u = -1, c = 0; c < i.length; c++)
        -1 !== u
  ...
  function S(e, n, r) {
    ...
    b && Object.defineProperty(u, b, { value: 'Module' });
              ...
              .then(function () {
                return (function e(t, n, r) {
                  ...
                  if (
                    ...
                    return (n.E = j.call(Promise.all(i).then(c), function () {
                      n.E = null;
                    }));
                  var u = c();
                  if (u)
                    return (n.E = j.call(u, function () {
                      n.E = null;
                    }));
                  function c() {
                    try {
    ...
    (P.set = function (e, t) {
      ...
      M && 'Module' === t[M]
        ...
        : ((n = Object.assign(Object.create(null), t)),
          M && Object.defineProperty(n, M, { value: 'Module' }));
      var r = Promise.resolve(n),
        i =
          this[O][e] ||
          (this[O][e] = { id: e, i: [], h: !1, d: [], e: null, er: void 0, E: void 0 });
    ...
    return function (t) {
      var n,
        ...
        o = (function (e, t) {
          ...
          return (
            i && (r = i),
            e.registerRegistry && (n = e.registerRegistry[r]) && (e.registerRegistry[r] = null),
            n
          );
        })(i, t);
      if (o) return o;
      ...
      return (
        (r = n),
        Boolean(r && 'function' == typeof r.then)
  ...
  ((I.resolve = function (e, t) {
    ...
    (I.warmup = function (t) {
      var n = t.pathname,
        ...
        l = t.handlers;
      if (
        ((_ = 'no-schema:'.concat(r)),
        o &&
          i &&
          (function (e, t) {
            p(e, t || _, L);
          })(i, 'no-schema:/'.concat(o)),
        Array.isArray(u))
      ) {
        var s,
          f = e(u);
