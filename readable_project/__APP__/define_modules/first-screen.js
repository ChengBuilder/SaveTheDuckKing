    ...
    (r.enable(r.BLEND),
      ...
      (function (e, r, n, t, a, o, i) {
        ...
        (e.enableVertexAttribArray(_),
          e.vertexAttribPointer(_, 1, e.FLOAT, !1, 12, 8),
...
module.exports = {
  start: function (n, t, o) {
    ...
    return (
      (e.alpha = 'true' === n),
      (e.antialias = 'false' !== t),
      'true' === o && (r = window.canvas.getContext('webgl2', e)),
      r
        ? (window.WebGL2RenderingContext = !0)
        : ((window.WebGL2RenderingContext = !1), (r = window.canvas.getContext('webgl', e))),
      (s = 2 / canvas.width),
      (f = 2 / canvas.height),
      (_ = new Float32Array([
        s,
      ...
      r.bufferData(r.ARRAY_BUFFER, _, r.STATIC_DRAW),
      (function () {
