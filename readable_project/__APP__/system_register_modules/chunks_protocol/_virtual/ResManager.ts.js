 ...
 * System.register("chunks:///_virtual/ResManager.ts")
 */
...
System.register(
  ...
  function (e) {
    ...
    return {
      ...
      execute: function () {
        var p;
        r._RF.push({}, '2619dP/MBtAxoTKFD6hfHG6', 'ResManager', void 0);
        var f = a.ccclass;
        (a.property,
          e(
            'ResManager',
              ...
              (p = (function (e) {
                function r() {
                  for (var t, n = arguments.length, i = new Array(n), o = 0; o < n; o++)
                    i[o] = arguments[o];
                  return (
                    ((t = e.call.apply(e, [this].concat(i)) || this)._assetsCache = new Map()),
                    t
                  );
                }
                t(r, e);
                                ...
                                return e.abrupt(
                                  ...
                                  new Promise(function (e, i) {
                                    s.loadBundle(t, n, function (t, n) {
                                      if (t)
                                        return (
                                          console.error('[LoadScene] 加载+bundleName+失败:', t),
                                          void i(t)
                                        );
                                      e(n);
                                    });
                        ...
                        return i().wrap(
                          function (e) {
                            for (;;)
                              switch ((e.prev = e.next)) {
                                case 0:
                                  ((o = t + ':' + l.getClassName(n)), this._assetsCache.set(o, n));
                                case 2:
                                case 'end':
                                  return e.stop();
                              }
