 ...
 * Parent define module: src/chunks/bundle.a5cc1.js
 * System.register("chunks:///_virtual/rollupPluginModLoBabelHelpers.js")
 */

System.register('chunks:///_virtual/rollupPluginModLoBabelHelpers.js', [], function (r) {
  return {
    execute: function () {
      function t(e, r, t, n, i, o, u) {
        try {
          var a = e[o](u),
            l = a.value;
        } catch (e) {
      ...
      r({
        ...
        createForOfIteratorHelperLoose: function (e, r) {
          ...
          if (Array.isArray(e) || (t = u(e)) || (r && e && 'number' == typeof e.length)) {
            t && (e = t);
            var n = 0;
            return function () {
